**2DO A**
| Asignatura | Cantidad de bloques |
|---|---:|
| Lengua | 3 |
| Ciencias Sociales | 2 |
...
**3RO A** es exactamente el mismo que el de los dos casos anteriores:
...
horario de **4TO A** es el siguiente:
