...
class ActivitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        /*******************list****************************/
        $list_grado = Grado::list_pestudio_grado(); //dd($list_grado);
        ...
        return view('academicos.activities.index',compact('pestudios','autoridad','pevaluacions','profesor_id','grado_id','list_grado','seccion_id','list_seccion','lapso_id','list_lapso'));
    }
    ...
    public function format($id)
    {
        ...
        return view('academicos.activities.format',compact('pevaluacion','activities','institucion','fecha'));
    }
    ...
    public function resume($id)
    {
        ...
        return view('academicos.activities.resume',compact('pevaluacion','activities','institucion','fecha'));
    }
}
