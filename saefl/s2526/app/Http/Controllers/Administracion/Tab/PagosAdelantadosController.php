...
class PagosAdelantadosController extends Controller
{
    public function dashboard()
    {
        ...
        return view('administracion.pagos_adelantados.home',compact('tasks','alerts','users','profiles','rols'));
    }
    ...
    public function index()
    {
        ...
        return view('administracion.pagos_adelantados.index',compact('users'));
    }
}
