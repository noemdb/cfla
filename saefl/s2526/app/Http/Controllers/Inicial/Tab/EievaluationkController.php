...
class EievaluationkController extends Controller
{
    ...
    public function index()
    {
        ...
        $lapsos = Lapso::all();
        $lapso_active = Lapso::current(); //dd($user);
        
        return view('inicials.eievaluationks.index',compact('user','autoridad','list_comment_autoridad','lapsos','lapso_active'));
    }
