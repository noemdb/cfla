...
namespace App\Http\Livewire\Evaluacion\Execution;
...
class IndexComponent extends Component
{
    ...
    public function mount()
    {
        ...
        $this->list_grado = Pestudio::list_pestudio_grado_manage($this->manager_id);
    ...
    {
        return view('livewire.evaluacion.execution.index-component', [
            'evaluaciones' => $this->getBaseQuery()->paginate(15)
        ]);
    }
    ...
    private function getBaseQuery()
    {
        return Evaluacion::with([
            ...
            'pevaluacion.pensum.pestudio.peducativo', // Incluir la relación hasta peducativo
        ])
    ...
    public function updatedPensumId($value)
    {
        $this->resetPage();
    }
    ...
    public function updatedFinicial($value)
    {
        $this->resetPage();
    }
    public function updatedFfinal($value)
    {
        $this->resetPage();
    }
    public function updatedStatusExecution($value)
    {
        //$this->resetPage();
    }
    ...
    public function change($id, $status)
    {
        ...
        // Emitir notificación SweetAlert
