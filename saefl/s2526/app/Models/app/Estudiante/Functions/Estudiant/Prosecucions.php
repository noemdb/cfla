...
trait Prosecucions
{
    ...
    // Accesor: psname → nombre de la sección
    public function getPsnameAttribute()
    {
        if ($this->prosecucion && $this->prosecucion->seccion) {
            return $this->prosecucion->seccion->name;
        }

        return null;
    }

    // Accesor: pgname → nombre del grado
    public function getPgnameAttribute()
    {
        if ($this->prosecucion && $this->prosecucion->seccion && $this->prosecucion->seccion->grado) {
            return $this->prosecucion->seccion->grado->name;
        }
