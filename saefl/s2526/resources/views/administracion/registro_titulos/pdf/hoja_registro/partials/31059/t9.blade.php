{{-- <table cellpadding="0" cellspacing="0" border="1" width="100%" style="font-size:0.7rem;margin-bottom:0.2rem;" class="table" > --}}
    <table cellpadding="2" cellspacing="2"  border="1" class="table-seccion grid">
    <TR>
