{!! Form::open(['route'=>'administracion.asisst_controls.assit_attendances.personal','method'=>'GET','class'=>'p-1 m-1', 'role'=>'search','files'=>'true']) !!}
    ...
    <div class="row">
        ...
        <div class="col-4">
            <div class="form-group">
                <label class="font-weight-bold text-secondary m-0" for="user_id">Personal</label>
                {!! Form::select('user_id',$list_users_worker,$user_id,['class'=>'form-control','id'=>'user_id','placeholder'=>'Seleccione']);!!}
            </div>
        </div>
