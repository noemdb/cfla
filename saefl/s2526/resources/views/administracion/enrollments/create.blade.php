    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['route' => 'administracion.enrollments.store', 'method' => 'POST', 'id'=>'form-inscripcion-create', 'class'=>'form-signin']) !!}
                    ...
                    <div class="card bd-callout bd-callout-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    @include('administracion.enrollments.deck.card.estudiant_simple')
                                </div>
                                <div class="col-9">
                                    @include('administracion.enrollments.form.fields')
