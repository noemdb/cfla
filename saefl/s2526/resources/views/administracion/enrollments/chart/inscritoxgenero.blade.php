@php ($chart = ['range'=>'Todos','id_chart'=>'inscri_aca_toxgenero_id'.Auth::user()->id,'urlapi'=>route('administracion.inscripcion.gender.chart'),'tipo'=>'pie','limit'=>6 ])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'enrollments académicas por género')
