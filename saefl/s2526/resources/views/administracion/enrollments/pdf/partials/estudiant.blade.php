<table cellspacing="1" cellpadding="1" class="table-sm" style="padding-top:0.4rem;font-size:0.6rem !important" border="1">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="11" style="font-weight: bold !important;font-size: 0.8rem !important">CURSOS (MARQUE CON UNA
                X LA CASILLA CORRESPONDIENTE)</td>
        </tr>
        <tr>
        ...
        <tr align="center">
            <td>{{ $enrollment?->grado_id == '1' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '2' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '3' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '4' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '5' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '6' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '7' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '8' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '9' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '10' ? 'X' : null }}</td>
            <td>{{ $enrollment?->grado_id == '11' ? 'X' : null }}</td>
        </tr>
