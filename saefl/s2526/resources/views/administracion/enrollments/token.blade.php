        ...
        <div class="card card-primary mt-2">
            <div class="card-header pb-0 mb-0 alert-secondary">
                <h3>
                    ...
                    Generación de código para solicitud de Matrícula
                    {{-- INI Menu rapido --}}
            ...
            <div class="card-body">
                ...
                @include('administracion.enrollments.form.search.index',['route'=>'administracion.enrollments.token','btn_toprint'=>'false'])
