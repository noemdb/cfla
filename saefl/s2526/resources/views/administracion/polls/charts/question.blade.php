@php ($chart = ['range'=>'Todos','id_chart'=>'poll_question_id_'.$poll_question->id,'urlapi'=>route('administracion.polls.question.chart'),'tipo'=>'pie','limit'=>$poll_question->id,'legend'=>true,'y_axes'=>'Preguntas','x_axes'=>'Participaciones'])
@section('scripts')
    @parent
