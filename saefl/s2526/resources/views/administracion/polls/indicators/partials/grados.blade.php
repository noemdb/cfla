        ...
        <li class="list-group-item p-2">
            <div class="ml-4">
                <div class=" d-flex justify-content-between align-items-center">
                    <div class=" font-weight-bold text-dark">{{ $grado->name ?? null }}</div>
                    <div>
                        <span class="text-muted small border rounded p-2 text-success">
                            <span class="">Participantes: {{ $count_answers ?? null }} || </span> <span
                                class="font-weight-bold">Invitaciones: {{ $count_tokens ?? null }}</span>
                        </span>
                    </div>
                </div>
                <div class="progress mt-2" style="height: 0.8rem;">
                    <div class="progress-bar bg-{{ $grado->color ?? null }} font-weight-bold" role="progressbar"
                ...
                <div class="p-1">
                    ...
                    @include('administracion.polls.indicators.partials.seccions')
                </div> 
                --}}
            </div>
