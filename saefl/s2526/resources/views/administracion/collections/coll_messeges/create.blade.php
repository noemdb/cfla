    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-header pb-0 mb-0 alert-secondary">
                {{-- INI Menu rapido --}}
                <div class="btn-group float-right pt-0 pb-2"> @include('administracion.collections.coll_messeges.menus.create') </div>
                {{-- FIN Menu rapido --}}

                <h3>Registrar un nuevo <span class="font-weight-bolder">Mensajes de Cobranza</span></h3>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'administracion.collections.coll_messeges.store', 'method' => 'POST', 'id'=>'form-collPolitical-create', 'class'=>'form-signin']) !!}
