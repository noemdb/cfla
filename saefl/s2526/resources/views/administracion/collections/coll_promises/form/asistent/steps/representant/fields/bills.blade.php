@php
    $stepShow = [
        'up'=>'step-register',
        'dowm'=>'step-representant-ident-2',
    ] ;
    $stepId = "step-representant-bill";
@endphp
...
<div class="first-of-type" id="{{$stepId}}">
    <div class="alert alert-secondary rounded px-4 py-2"  style="min-height: 25rem;">
        <div>
            @include('administracion.collections.coll_promises.form.asistent.steps.representant.partials.bills')
        </div>
    </div>
