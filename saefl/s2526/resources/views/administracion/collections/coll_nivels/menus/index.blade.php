@component('elements.buttons.default')
    @slot('title', 'Registrar nueva política de cobranza')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.collections.coll_politicals.create'))
    @slot('icon', $icon_menus['nuevo'])
@endcomponent

@component('elements.buttons.default')
    @slot('title', 'Políticas de Cobro registradas')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.collections.coll_politicals.crud'))
