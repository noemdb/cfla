...
@component('elements.buttons.default')
    @slot('title', 'Listado')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.collections.coll_nivels.crud'))
    @slot('icon', $icon_menus['crud'])
@endcomponent

@component('elements.buttons.default')
    @slot('title', 'Registrar nuevo nivel de cobranza')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.collections.coll_nivels.create'))
