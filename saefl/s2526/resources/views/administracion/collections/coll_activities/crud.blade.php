    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-header pb-0 mb-0 alert-secondary">
                {{-- INI Menu rapido --}}
                <div class="btn-group float-right pt-0 pb-2"> @include('administracion.collections.coll_activities.menus.crud') </div>
                {{-- FIN Menu rapido --}}
            ...
            <div class="card-body">
                ...
                @include('administracion.collections.coll_activities.table.crud')
