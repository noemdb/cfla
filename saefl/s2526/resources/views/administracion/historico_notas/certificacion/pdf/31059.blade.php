...
<body>
    ...
    <div class="page">
        ...
        {{-- I. Plan de Estudio: --}}
        @includeIf('administracion.historico_notas.certificacion.pdf.partials.t1')

        {{-- II. Datos del Plantel o Zona Educativa que emite la Certificación --}}
        @includeIf('administracion.historico_notas.certificacion.pdf.partials.t2')
            ...
            <tbody>
                <tr>
                    <td width="50%">
                        ...
                        @includeIf('administracion.historico_notas.certificacion.pdf.partials.t3',['grado'=>$grado])
                    </td>
                    <td width="50%">
                ...
                <tr>
                    ...
                    <td valign="top" width="50%">
                        @includeIf('administracion.historico_notas.certificacion.pdf.partials.t4')
                    </td>
                </tr>
            </tbody>
        </table>
