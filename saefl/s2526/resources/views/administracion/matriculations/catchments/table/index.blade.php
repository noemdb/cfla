...
<table width="100%" class="table table-striped table-hover table-sm small p-1" id="table-data-default">
    <thead>
        <tr>
            ...
            {{-- <th class="{{ $class['representant_ci'] }}">CI</th> --}}
    ...
    @foreach($catchments as $catchment)
        ...
        @php 
            ...
            // $activities = ($group) ? $group->activities->where('date','<=',$created_at) : collect();
        ...
        <tr data-id="{{$catchment->id}}" class="{{($status_accepted) ? 'table-success' : null}}">
            ...
            <td class="{{ $class['representant_name']  ?? null}}">
                ...
                <div class="text-muted">
                    <div>@admin {{$catchment->token ?? ''}} @endadmin</div>
            ...
            <td class="{{ $class['representant_name']  ?? null}}">
                ...
                @php $catchment_interview = $catchment->catchmentInterviews->sortByDesc('created_at')->first(); @endphp
            ...
            <td class="{{ $class['action'] ?? null }}">
                <div class="btn-group btn-group-sm">
                    ...
                    @php $status_delete = $catchment->status_delete; @endphp
...
{!! Form::open(['route' => ['administracion.matriculations.catchments.destroy',':CATCHMENT_ID'], 'method' => 'DELETE', 'id'=>'form-destroy', 'role'=>'form']) !!}
