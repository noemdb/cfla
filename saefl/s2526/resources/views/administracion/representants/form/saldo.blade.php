<div class="card-header p-0 m-0 mb-3">
    ...
    <div class="row mt-2">
        <div class="col-2">
            <div class="font-weight-bold">Núm. Estudiantes</div>
            {!! Form::selectRange('count_estudiants', 1, 8, $count_estudiants, [
                'class' => 'form-control',
                'placeholder' => 'Seleccione',
            ]) !!}
        </div>
        <div class="col-2">
            <div class="font-weight-bold">Núm. Coutas</div>
            {!! Form::selectRange('num_cuotas', 1, 13, $num_cuotas, [
                'class' => 'form-control',
                'placeholder' => 'Seleccione',
            ]) !!}
        </div>
