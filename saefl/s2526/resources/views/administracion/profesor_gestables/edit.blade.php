        ...
        <div class="card card-primary mt-2">
            <div class="card-header alert-secondary">
                ...
                <div class="btn-group float-right pt-2">
                    @include('administracion.pevaluacions.menus.edit')
                </div>
            ...
            <div class="card-body">
                    ...
                    {!! Form::model($pevaluacion,['route' => ['administracion.pevaluacions.update', $pevaluacion->id], 'method' => 'PUT', 'id'=>'form-update-boletin_'.$pevaluacion->id, 'role'=>'form']) !!}
