@component('elements.buttons.default')
    @slot('title', 'Profesores Guía')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.profesor_guias.index'))
    @slot('icon', $icon_menus['pevaluacion'])
@endcomponent

@component('elements.buttons.default')
    @slot('title', 'Evaluaciones')
    @slot('class_bt', 'info')
    @slot('route', route('administracion.profesor_guias.create',['grado_id'=>$grado->id,'seccion_id'=>$seccion->id,'pensum_id'=>$pensum->id,'lapso_id'=>$lapso->id]))
...
@component('elements.buttons.default')
    @slot('title', 'Listado')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.profesor_guias.crud'))
