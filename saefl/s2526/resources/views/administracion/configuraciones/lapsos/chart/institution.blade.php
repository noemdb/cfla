...
@php ($chart = ['range'=>'Todos','id_chart'=>'institution_id_'.Auth::user()->id,'urlapi'=>route('administracion.lapso.census.chart.institution'),'tipo'=>'pie','limit'=>6,'legend'=>true,'y_axes'=>'Cantidad','x_axes'=>'Institución'])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Censo Escolar - Institución de Origen')
