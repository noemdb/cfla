...
@php ($chart = ['range'=>'Todos','id_chart'=>'municipio_'.Auth::user()->id,'urlapi'=>route('administracion.lapso.census.chart.municipio'),'tipo'=>'pie','limit'=>6,'legend'=>true,'y_axes'=>'Cantidad','x_axes'=>'Grados'])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Censo Escolar - Municipio de Nacimiento')
