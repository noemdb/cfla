@component('elements.buttons.default')
    @slot('title', 'Listado de Planes de Pago registrados')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.planpagos.index'))
    @slot('icon', $icon_menus['crud'])
@endcomponent
@component('elements.buttons.default')
    @slot('title', 'Crear nueva Planes de Pago')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.configuraciones.planpagos.create'))
