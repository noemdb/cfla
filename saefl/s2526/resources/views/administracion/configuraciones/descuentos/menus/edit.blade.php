@component('elements.buttons.default')
    ...
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.descuentos.index'))
    @slot('icon', $icon_menus['crud'])
@endcomponent
@component('elements.buttons.default')
    @slot('title', 'Crear nueva descuento')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.configuraciones.descuentos.create'))
