@component('elements.buttons.default')
    @slot('title', 'Listado de Asignaturas')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.asignaturas.index'))
    @slot('icon', $icon_menus['crud'])
@endcomponent
@component('elements.buttons.default')
    @slot('title', 'Crear nueva asignatura')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.configuraciones.asignaturas.create'))
