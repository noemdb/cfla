@php ($chart = ['range'=>'','id_chart'=>'deuda_Representante_month','urlapi'=>route('administracion.configuraciones.bancos.deuda_Representante_month.chart'),'tipo'=>'horizontalBar','limit'=>6,'legend'=>true,'y_axes'=>'Porcentaje','x_axes'=>'Mes' ])
@section('scripts')
    @parent
