@component('elements.buttons.default')
    @slot('title', 'Listado')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.peducativos.index'))
...
@admin
@component('elements.buttons.default')
    @slot('title', 'Registrar Programa Educativo')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.configuraciones.peducativos.create'))
