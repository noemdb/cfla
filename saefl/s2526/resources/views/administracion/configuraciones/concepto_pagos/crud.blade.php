        ...
        <div class="card card-primary mt-2">
            <div class="card-header  alert-info">
                <h4>
                    ...
                    <span title="Listado especial con botones de acción"><u>Listado</u></span> de Cuentas de Cobro
            ...
            <div class="card-body">
                ...
                @include('administracion.configuraciones.concepto_pagos.table.crud')  

            </div>
        </div>
    </main>
    {!! Form::open(['route' => ['administracion.configuraciones.concepto_pagos.destroy',':CONCEPTO_PAGO_ID'], 'method' => 'POST', 'id'=>'form-retirar', 'role'=>'form']) !!}
    {!! Form::close() !!}
    @section('scripts')
        @parent
