@component('elements.buttons.default')
    @slot('title', 'Listado de las Cuentas de Cobros registradas')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.concepto_pagos.index'))
