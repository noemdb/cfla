...
@component('elements.buttons.default')
    @slot('title', 'Crear nueva Cuenta de cobro')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.configuraciones.concepto_pagos.create'))
    @slot('icon', $icon_menus['nuevo'])
@endcomponent

@component('elements.buttons.default')
    @slot('title', 'Listado de Cuentas de Cobro')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.concepto_pagos.crud'))
