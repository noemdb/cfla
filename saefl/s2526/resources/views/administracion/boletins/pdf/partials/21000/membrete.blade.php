<table width="100%" cellpadding="0" cellspacing="0" style=" font-size:0.8rem;margin-bottom:0.2rem; padding-bottom:0.2rem;">
    <thead>
        <tr>
            <th scope="row" width="60px">
                <img width="60px" height="50px" class="card-img-top" src="{{ asset('images/avatar/uecfla.jpg') }}">
            </th>
            <th>
            ...
            <th scope="row" width="60px">
                <img width="100px" height="50px" class="card-img-top" src="{{ asset('images/avatar/amigoniano.png') }}">
            </th>
        </tr>
    </thead>
</table>
