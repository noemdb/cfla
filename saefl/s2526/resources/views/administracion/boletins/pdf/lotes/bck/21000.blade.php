...
<body>
    ...
    @foreach ($estudiants as $estudiant)
        ...
        <div class="page">
            ...
            <h4 style="margin-top:0.2rem; padding-top:0.2rem;margin-bottom:0.2rem; padding-bottom:0.2rem;background-color:#e0e0e0">
            ...
            <table class="table table-sm small" style="margin-bottom:0.2rem; padding-bottom:0.2rem;width:100%">
                <thead>
                    <tr>
            ...
            <table class="table table-sm small" style="width:100%">
                ...
                <thead>
                    <tr style="background-color:#e0e0e0">
                        <th style="width:94%;font-size:0.8rem;text-align:left"><b>Áreas de Aprendizaje: Profesor y Aprendizajes esperados</b></th>
                        {{-- <th style="width:6%;font-size:1rem;text-align:center"><b>Nota</b></th> --}}
                        <th style="width:6%;font-size:0.8rem;text-align:center"><b>Val.</b></th>
                    </tr>
                </thead>
                ...
                <tbody id="tdatos">
                    ...
                    @foreach ($pensums as $pensum)
                        ...
                        <thead style="background-color:#e0e0e0">
                            <tr>
                                <td style="width:94%;font-size:0.8rem;text-align:left">
                                    ...
                                    <tbody id="tdatos">
                                        @foreach ($evaluacions as $evaluacion)
                                            ...
                                            <tr style="font-size:0.7rem">
                                                ...
                                                {{-- <td style="width:6%; text-align:center">{{ (!empty($boletin->nota)) ? $boletin->getBaremo( $pestudio->id )->valoracion : null }}</td> --}}
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                ...
                {{-- <thead style="background-color:grey"> --}}
                    <tr style="font-size:1.2rem;background-color:#e0e0e0">
                        ...
                        <td style="text-align:center"><b>{{$baremo->getValoracion($pestudio->id,$notal_total)->valoracion}}</b></td>
                    </tr>
                {{-- </thead> --}}
