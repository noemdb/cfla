...
<body>
    ...
    <table class="table table-sm small" style="width:100%">
        ...
        <thead class="thead-inverse">
            <tr>
                <th style="width:88%;font-size:1rem;text-align:left"><b>Áreas de Aprendisaje: Profesor y Aprendisajes esperados</b></th>
        ...
        <tbody id="tdatos">
            ...
            @foreach ($pensums as $pensum)
                ...
                <thead style="background-color:grey">
                    <tr>
                        <td style="width:88%;font-size:1rem;text-align:left">
                            ...
                            <tbody id="tdatos">
                                @foreach ($evaluacions as $evaluacion)
                                    ...
                                    <tr style="font-size:0.8rem">
                                        <td style="width:88%">{{$loop->iteration}}. {{ strtoupper($evaluacion->description) }}</td>
        ...
        {{-- <thead style="background-color:grey"> --}}
            <tr style="font-size:1.2rem;background-color:grey">
                ...
                <td style="text-align:center"><b>{{$baremo->getValoracion($pestudio->id,$notal_total,$lapso->id)->valoracion}}</b></td>
            </tr>
        {{-- </thead> --}}
    ...
    <table class="table table-sm small" style="margin-top:0.5rem; padding-top:0.5rem;width:50%;font-size:0.8rem;">
        <thead  class="thead-inverse">
            <tr>
