        ...
        <div class="col-3">
            <div class="btn-group btn-group btn-block">
                ...
                @if (!empty($btn_toprint))
                    <a id="btn_toprint" class="btn btn-dark {{ $estudiants->isEmpty() ? 'disabled' : null }}"
                        href="#" role="button" title="Generar PDF">
                        <i class="fa fa-file-pdf" aria-hidden="true"></i>
                    </a>
                @endif
                @if (!empty($btn_toprint_lote))
                    <a id="btn_toprint_lote" class="btn btn-light {{ $estudiants->isEmpty() ? 'disabled' : null }}"
                        href="#" role="button" title="Genera PDF de todos los grados del lapso seleccionado">
