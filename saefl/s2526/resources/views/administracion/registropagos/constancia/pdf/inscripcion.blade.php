...
<body>
    ...
    <p style="text-align:justify;">
        ...
        años de edad, natural de {{$inscripcion->estudiant->city_birth ?? ''}}, está inscrita en esta Institución
        para cursar estudios en el periodo académico {{ Session::get('pescolar_name') }}.
    </p>
    <p>
