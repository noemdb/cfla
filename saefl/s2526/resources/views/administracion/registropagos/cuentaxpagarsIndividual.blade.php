        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-body p-2">
                ...
                <div class="card-header p-0 m-0 mb-2">
                    {!! Form::open(['route'=>'administracion.registropagos.cuentaxpagars.individual','method'=>'GET','class'=>'pb-1','id'=>'form_search','role'=>'search']) !!}

                        @include('administracion.registropagos.form.search.cuentaxpagarsIndividual')
                ...
                @include('administracion.registropagos.table.cuentaxpagarsIndividual')
