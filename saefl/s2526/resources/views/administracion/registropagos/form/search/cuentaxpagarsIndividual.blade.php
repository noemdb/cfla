<div class="form-row">
    ...
    <div class="col-2 pr-0">
        <label for="cuentaxpagar_id" class="m-0 font-weight-bold">R. Morosidad</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">
                    <i class="{{ $icon_menus['morosidad'] ?? '' }} fa-1x"></i>
                </span>
            </div>
            {!! Form::select('morosidad', ['SI' => 'SI', 'NO' => 'NO'], $morosidad, [
                'class' => 'form-control',
                'id' => 'morosidad',
    ...
    <div class="col-2 pr-0">
        <label for="planpago_id" class="m-0 font-weight-bold">Plan de Pago (Filtro avanzado)</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">
