...
@section('title')
    Asistente Interactivo para el registro de pagos - {{ Auth::user()->rol ?? '' }}
@endsection
...
@section('main')
    <main role="main" class="col-md-10 col-lg-10">
        ...
        <div class="pt-2">
            ...
            {{-- <livewire:administracion.registro-pago.asistent-livewire :representant_id="$representant->id" /> --}}

            	@livewire('administracion.recargos.generar-recargo')
