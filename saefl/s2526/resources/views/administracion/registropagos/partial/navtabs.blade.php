<nav class="pt-1 mt-1">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a class="nav-item nav-link pt-2 active" id="nav-tab01-tab" data-toggle="tab" href="#nav-tab01" role="tab" aria-controls="nav-tab01" aria-selected="true" title="Datos de la Transacción">Transacción</a>
        {{-- <a class="nav-item nav-link pt-2" id="nav-tab02-tab" data-toggle="tab" href="#nav-tab02" role="tab" aria-controls="nav-tab02" aria-selected="false" title="Pago">Pago</a> --}}
        ...
        <a class="nav-item nav-link pt-2" id="nav-tab03-tab" data-toggle="tab" href="#nav-tab03" role="tab" aria-controls="nav-tab03" aria-selected="false" title=" Cuentas de cobro"> Cuentas de cobro</a>
...
<div class="tab-content" id="nav-tabContent">
    ...
    {{-- <div class="tab-pane fade" id="nav-tab02" role="tabpanel" aria-labelledby="nav-tab02-tab">
        @include('administracion.registropagos.form.fields.pago')
    </div> --}}
    <div class="tab-pane fade" id="nav-tab05" role="tabpanel" aria-labelledby="nav-tab05-tab">
        @include('administracion.registropagos.form.fields.credito')
    </div> 
