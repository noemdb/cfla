...
<div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            @include('administracion.registropagos.book.table.pestudios')                        
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    @include('administracion.registropagos.chart.inscritoxgenero')                                    
                </div>
                <div class="col-md-12 col-lg-6">
                    @include('administracion.registropagos.chart.genderxplan')                                    
                </div>                                
            </div>
        </div>                            
    </div>
