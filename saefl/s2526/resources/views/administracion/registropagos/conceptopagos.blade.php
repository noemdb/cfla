...
@section('title') - Conceptos Pendientes Representante {{ Carbon\Carbon::now()->format('Y-m-d h:m') }} - Total: {{ $representants->count() ?? ''}} @endsection
    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-header alert-secondary">
                ...
                {{-- FIN Menu rapido --}}
                <h4>
                    <span title="Listado especial con botones de acción"><u>Listado</u></span> de <span class="font-weight-bolder">Representantes con cuentas de cobro pendiente</span>
                    @if($cuentaxpagar)
            ...
            <div class="card-body p-2">
                ...
                <div class="card-header p-0 m-0 mb-2">
                    {!! Form::open(['route'=>'administracion.registropagos.conceptopagos','method'=>'GET','class'=>'pb-1','id'=>'form_search','role'=>'search']) !!}

                        @include('administracion.registropagos.form.search.conceptopagos')
                ...
                @if($monto_total)
                    @php
                        $goal = $allRepresentants->count();
                        $real = $representants->count();
                    ...
                    <div class=" bg-light pb-1 font-weight-bold d-block alert-dark">
                        <div class="float-right d-block">
                            ...
                            {{-- Nº <span>{{ $representants->count() ?? ''}}</span> --}}
                        </div>
                    </div>
                @endif
