<div class="card-header p-0 m-0 mb-3">
    ...
    <div class="form-row font-weight-bold">
        <div class="col-4">Archivo CSV</div>
        <div class="col-2">Delimitador</div>
        <div class="col-2">Codificación</div>
        <div class="col-2">Fecha Limite</div>
        <div class="col-2">&nbsp;</div>
    </div>
    <div class="form-row">
        ...
        <div class="col-2">
            {!! Form::date('fecha_limit', $fecha_limit, ['class' => 'form-control', 'id' => 'fecha_limit']) !!}
        </div>
        ...
        <div class="col-2">
            ...
            @include('administracion.prepagos.partials.search_help')
        </div>
