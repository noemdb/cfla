@php
    ...
    $class_image_1="d-none d-xl-table-cell table-warning";
    ...
    $class_image_2="d-none d-xl-table-cell table-secondary";
    ...
    $class_image_3="d-none d-xl-table-cell table-primary";
