@component('elements.buttons.default')
    @slot('title', 'Plan de Evaluación asociado a ésta evaluación')
...
@component('elements.buttons.default')
    ...
    @slot('class_bt', 'light')
    @slot('route', route('administracion.evaluacions.crud'))
...
{{-- @component('elements.buttons.default')
    ...
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.pevaluacions.create'))
