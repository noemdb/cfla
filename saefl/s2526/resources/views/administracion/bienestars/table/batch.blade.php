                ...
                <tr data-estudiant_id="{{$estudiant->id ?? ''}}" data-id="{{$estudiant->id ?? ''}}" class="{{($status_active) ? '':'table->danger'}}">
                    ...
                    <td class="{{ $class_action ?? '' }}" id="btn-action-{{ $estudiant->id }}">
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            <a title="Imprimir ficha del estudiante" class="btn btn-secondary bnt-sm" href="{{ route('administracion.bienestars.pdf.ficha.estudiant',$estudiant->id) }}" role="button" target="_BLANK">
