@component('elements.buttons.default')
    @slot('title', 'Listado')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.boletin_revisions.index'))
    @slot('icon', $icon_menus['crud'])
@endcomponent

@component('elements.buttons.default')
    @slot('title', 'Registrar nueva Revisióm de Notas')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.boletin_revisions.create',$estudiant->id))
