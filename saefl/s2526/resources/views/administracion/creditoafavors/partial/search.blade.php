...
<div class="card-header p-0 m-0 mb-3">
    ...
    <div class="form-row font-weight-bold">
        ...
        <div class="col-3">Identificador <span
                class=" font-weight-normal text-muted small">[Estudiante/Representante]</span></div>
        <div class="col-2">Estado</div>
        <div class="col-2">Omitido</div>
    ...
    <div class="form-row">
        ...
        <div class="col-2">
            {!! Form::select('status_omitted', ['SI' => 'SI', 'NO' => 'NO'], $status_omitted, [
                'class' => 'form-control',
                'id' => 'status_omitted',
                'placeholder' => 'Seleccione',
            ]) !!}
...
@include('administracion.creditoafavors.modal.filters')
