...
<head>
    ...
    <title>Libro de Inscripciones Académicas {{ Session::get('pescolar_name') }}</title>
...
<body>
    ...
    <h3 style="text-align:center;">Libro de Inscripciones Académicas</h3>
    ...
    @isset($grados)
        ...
        @include('administracion.inscripciones.book.table.grados')
    @endisset
    <hr>
