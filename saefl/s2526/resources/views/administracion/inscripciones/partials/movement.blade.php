<div class="card-header p-0 m-0 mb-3">
    ...
    <div class="continer-fluiid">
        <div class="row font-weight-bold">
            <div class="col-4">Grado/</div>
            <div class="col-3">Sección</div>
            <div class="col-3" title="Fecha del último reporte generado">Fecha del último reporte</div>
            <div class="col-2">&nbsp;</div>
        </div>
        <div class="row">
            <div class="col-4">
            ...
            <div class="col-3">
                {!! Form::date('lastdate', $lastdate, ['class' => 'form-control', 'id' => 'lastdate']) !!}
            </div>
            <div class="col-2">
