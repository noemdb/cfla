@php ($chart = ['range'=>'0','id_chart'=>'ingresoxdaymonth_id_'.Auth::user()->id,'urlapi'=>route('administracion.configuraciones.bancos.ingresoxdayxmonth.chart'),'tipo'=>'line','limit'=>6 ]) @endphp
@section('scripts')
    @parent
