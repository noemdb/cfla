@php ($chart = ['range'=>'0','id_chart'=>'area_conocimientos_'.$pestudio->id,'urlapi'=>route('administracion.area_conocimientos.promedio_x_area.chart',['pestudio_id'=>$pestudio->id]),'tipo'=>'horizontalBar','limit'=>10,'legend'=>true,'y_axes'=>'Promedio','x_axes'=>'Áreas de conocimiento'])
@section('scripts')
    @parent
