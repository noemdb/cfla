{!!Form::open(['route'=>'administracion.preinscripcions.pago.store','method'=>'POST','id'=>'form-preinscripcions-create','class'=>'form-signin','id'=>'form-pago-store-'.$prepago->id])!!}
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class=" border h-100 rounded p-2">
                        @include('administracion.preinscripcions.form.fields.pago')
                    </div>
                </div>

                <div class="col-4">
                    <div class=" border h-100 rounded p-2">
                        @includeIf('administracion.preinscripcions.form.pago.abn_caf_desc')
                    </div>
                </div>

                <div class="col-4">
                    <div class=" border h-100 rounded p-2">
                        @include('administracion.preinscripcions.form.pago.cuentasxpagars')
                    </div>
                </div>
...
<script type="text/javascript">
    //ini del evento clic
     $('.btn-pago-store').click(function (e) {
         ...
         var url = "{{ route('administracion.preinscripcions.pago.store') }}"; //console.log(url);
