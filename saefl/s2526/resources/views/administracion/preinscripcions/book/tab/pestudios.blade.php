...
<div class=" border rounded p-2">
    ...
    <div class="tab-content p-2 border border-top-0" id="nav-tabContent">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        @include('administracion.preinscripcions.chart.inscritoxgenero')
                    </div>
                    <div class="col-md-12 col-lg-6">
                        @include('administracion.preinscripcions.chart.genderxplan')                                    
                    </div>                                
                </div>
            </div>                            
        </div>
