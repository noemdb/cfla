@php ($chart = ['range'=>'Todos','id_chart'=>'inscri_aca_toxgenero_id'.Auth::user()->id,'urlapi'=>route('administracion.preinscripcions.gender.chart'),'tipo'=>'pie','limit'=>6 ])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Prenscripciones por género')
