@php ($chart = ['range'=>'Todos','id_chart'=>'inscr_aca_toxgeneroxgrado_id','urlapi'=>route('administracion.preinscripcions.genderxgrado.chart'),'tipo'=>'bar','limit'=>11,'legend'=>true,'y_axes'=>'Estudiantes','x_axes'=>'Grados'])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Prenscripciones - Género por Grado')
