@php ($chart = ['range'=>'Todos','id_chart'=>'inscri_aca_genderxplan_id','urlapi'=>route('administracion.preinscripcions.genderxplan.chart'),'tipo'=>'bar','limit'=>6,'legend'=>true,'y_axes'=>'Estudiantes','x_axes'=>'Plan Educativo'])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Preinscripciones - Género por Plan Estudio')
