@php
    $stepShow = [
        'up'=>'step-recibo_pagos',
        'dowm'=>'step-recibo_cashes',
    ] ;
    $stepId = "step-recibo_changes";
@endphp
...
<div class="first-of-type" id="{{$stepId}}">
    ...
    <div class="alert alert-secondary rounded flex-center px-4 py-2"  style="min-height: 25rem;">
        <div class="w-100">
            <h4>Ingrese los datos de los billetes del vuelto</h4>
            @include('administracion.receibts.form.recibo_changes',['list_comment'=>$list_comment_arr['recibo_changes']])
        </div>
    </div>
