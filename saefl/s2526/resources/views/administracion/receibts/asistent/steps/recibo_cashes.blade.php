@php
    $stepShow = [
        'up'=>'step-recibo_changes',
        'dowm'=>'step-start',
    ] ;
    $stepId = "step-recibo_cashes";
@endphp
...
<div class="first-of-type" id="{{$stepId}}">
    ...
    <div class="alert alert-secondary rounded flex-center px-4 py-2"  style="min-height: 25rem;">
        <div class="w-100">
            <h4>Ingrese los datos de los billetes</h4>
            @include('administracion.receibts.form.recibo_cashes',['list_comment'=>$list_comment_arr['recibo_cashes']])
        </div>
    </div>
