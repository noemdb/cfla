@php ($chart = ['range'=>1,'id_chart'=>'lessons_id_'.Auth::user()->id,'urlapi'=>route('evaluacions.charts.evaluacions.actividades'),'tipo'=>'line','limit'=>10,'legend'=>true,'y_axes'=>'Cantidad de Evaluaciones','x_axes'=>'Días'])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header','Cantidad diaria de lecciones registradas')
...
<div class="text-muted">
    En la gráfica se puede ver el total de diarias lecciones registradas de los profesores asociados al Área de Conocimeinto
</div>
