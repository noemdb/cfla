<div class="card">
    ...
    <div class="card-body">
        ...
        {!! Form::model($inscripcion,['route' => ['representants.inscripciones.update', $inscripcion->id], 'method' => 'PUT', 'id'=>'form-update_'.$inscripcion->id, 'role'=>'form']) !!}
            @include('representants.inscripciones.form.fields.grupo_estable')
