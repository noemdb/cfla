                ...
                <tr data-id="{{$inscripcion->id ?? ''}}">
                    ...
                    <td class="{{ $class_action ?? '' }}" id="btn-action-{{ $estudiant->id }}">
                        ...
                        <div class="btn-group btn-group-sm">
                            <a class="btn btn-primary" href="{{route('representants.preinscripcions.constancia.prosecucion.pdf',$estudiant->id)}}" target="_blank" role="button">
...
@section('scripts')
    ...
    <script>
        $('.btn-ge').click(function (e) {
            ...
            var ajaxurl = '{{route("representants.ajax.fill.modal.inscripcions.grupo_estable.update", "_id_")}}';
