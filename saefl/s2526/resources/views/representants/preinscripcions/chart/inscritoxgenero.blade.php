@php ($chart = ['range'=>'Todos','id_chart'=>'inscri_aca_toxgenero_id'.Auth::user()->id,'urlapi'=>route('representants.inscripcion.gender.chart'),'tipo'=>'pie','limit'=>6 ])
@section('scripts')
    @parent
...
@component('representants.elements.card.panel')
    ...
    @slot('header', 'Preinscripciones académicas por género')
