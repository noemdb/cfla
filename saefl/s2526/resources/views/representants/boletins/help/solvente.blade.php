<div class="card  border rounded shadow-sm border border-info">
    ...
    <div class="card-body py-1 my-1 text-justify">
        ...
        para la fecha de finalización del <b>Momento</b> respectivo
    </div>
    <hr>
        ...
        <div class="row">
            <div class="col-6">
                <div class=" p-2 text-center">
                    ...
                    <div>
                        <img src="{{ asset('images/example/boletins/btnSolvente.png') }}" width="92" class="img-fluid img-thumbnail" alt="">
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class=" p-2 text-center">
                    ...
                    <div>
                        <img src="{{ asset('images/example/boletins/btnInSolvente.png') }}" width="92" class="img-fluid img-thumbnail p-1 m-1" alt="">
                    </div>
