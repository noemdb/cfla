            ...
            class="table-{{(empty($pevaluacion->administrativa->id)) ? 'default':'success'}}">
                ...
                <td class="{{ $class_action ?? '' }}" id="btn-action-{{ $pevaluacion->id }}">
                    <div class="btn-group">
                        ...
                        <a title="Registrar Evaluaciones" class="btn {{$class_btn ?? ''}}" href="{{route('representants.evaluacions.create',$pevaluacion->id)}}" role="button">
                        ...
                        <a title="Registro de Notas" class="btn {{$class_btn ?? ''}} {{$disabled ?? ''}} btn-primary" href="{{route('representants.boletins.carga',['pevaluacion_id'=>$pevaluacion->id])}}" role="button">
