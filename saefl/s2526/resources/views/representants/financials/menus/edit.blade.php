@component('elements.buttons.default')
    @slot('title', 'Listado de los Planes de Evaluaciones')
    @slot('class_bt', 'light')
    @slot('route', route('representants.pevaluacions.crud'))
...
@component('elements.buttons.default')
    ...
    @slot('class_bt', 'light')
    @slot('route', route('representants.evaluacions.crud'))
    @slot('icon', $icon_menus['crud'])
@endcomponent

{{-- @component('elements.buttons.default')
    @slot('title', 'Crear nuevo plan de evaluación')
    @slot('class_bt', 'primary')
    @slot('route', route('representants.pevaluacions.create'))
