@php ($chart = ['range'=>'3','id_chart'=>'ingresoxmetodo_id_'.Auth::user()->id,'urlapi'=>route('administracion.configuraciones.bancos.ingresoxmetodo.chart'),'tipo'=>'bar','limit'=>6,'legend'=>false ] )
@section('scripts')
    @parent
