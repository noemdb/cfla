<div class="card">
    ...
    <div class="card-body">
        ...
        {!! Form::model($inscripcion,['route' => ['representants.ayudas.update', $inscripcion->id], 'method' => 'PUT', 'id'=>'form-update_'.$inscripcion->id, 'role'=>'form']) !!}
            @include('representants.ayudas.form.fields.grupo_estable')
