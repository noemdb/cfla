        ...
        <div class="card card-primary mt-2">
            <div class="card-header pb-0 mb-0 alert-secondary">
                <h3>
                    ...
                    {{-- @include('representants.ayudas.menus.book') --}}
            ...
            <div class="card-body">
                ...
                {!! Form::open([
                    'route' => 'representants.ayudas.list.pdf',
                    'method' => 'POST',
                    'class' => '',
                    'role' => 'search',
                    'target' => '_blank',
                ...
                {{-- @isset($pestudios)
                    ...
                    @include('representants.ayudas.book.pestudios')
                @endisset

                @isset($grados)
                    <h5>Grados</h5>
                    @include('representants.ayudas.book.grados')
                @endisset

                @isset($tinscripcions)
                    <h5>TIPO DE INSCRIPCIÓN</h5>
                    @include('representants.ayudas.book.tinscripcions')
                @endisset --}}

                {{-- @include('representants.ayudas.deck.inscripcion') --}}
