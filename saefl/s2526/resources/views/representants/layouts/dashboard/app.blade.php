@extends('representants.layouts.app')
...
@section('body')
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 navbar-expand-md" style="background-color:{{env('APP_NAV_COLOR','#004000')}} !important">
        ...
        @include('representants.layouts.dashboard.navbar.app')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-2 h-100">
                @includeif('representants.card.representant')
            </div>
            <div class="col-sm-10">
                @yield('main')
            </div>
...
@section('footer')
    @include('representants.layouts.footer.dashboard')
@endsection
