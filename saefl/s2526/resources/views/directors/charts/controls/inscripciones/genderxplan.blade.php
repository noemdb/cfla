@php ($chart = ['range'=>'Todos','id_chart'=>'inscri_aca_genderxplan_id','urlapi'=>route('directors.charts.control.inscripcions.genderxplan'),'tipo'=>'bar','limit'=>6,'legend'=>true,'y_axes'=>'Estudiantes','x_axes'=>'Plan Educativo'])
@section('scripts')
    @parent
