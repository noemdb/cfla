@php ($chart = ['range'=>'Todos','id_chart'=>'inscritoxgeneroxgrado_id'.Auth::user()->id,'urlapi'=>route('administracion.administrativas.genderxgrado.chart'),'tipo'=>'bar','limit'=>11,'legend'=>true,'y_axes'=>'Estudiantes','x_axes'=>'Grados' ])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Ins. Administrativas - Género por Grado')
