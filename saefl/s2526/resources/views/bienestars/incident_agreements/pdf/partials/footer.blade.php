...
<table width="100%" class="table table-striped table-hover table-sm small p-1"
    style="font-size:0.6rem;margin-bottom:0.1rem; padding-bottom:0.1rem;">
    <tr>
        <td align="center">
...
<footer class="text-muted" style="font-size:7px;">
    Registrado por: {{ $incident_agreement->user ? $incident_agreement->user->profile->full_name : null }} || Impreso
    por: {{ Auth::user()->profile->full_name ?? '' }}
    <hr>
    <span>
