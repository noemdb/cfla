        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 p-1">
                    ...
                    <div class="card-header  alert-dark mt-2">
                        ...
                        <h3 class="mb-0 pb-0">
                            ...
                            <div class="btn-group float-right pt-0 pb-2">
                                @include('bienestars.student_records.menu.summaries')
                            </div>
                    ...
                    @include('bienestars.student_records.partials.details.general')

                    <hr>

                    @include('bienestars.student_records.partials.summaries.patologies')
