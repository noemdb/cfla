        ...
        <tr>
            <td style="width: 100%;">
                ...
                <p style="text-align: justify;">
                    ...
                    han registrado una incidencia identificada con el código BE-I{{ $incident->id ?? null}}, realcionada al estudiante <span style="font-weight: bold;">{{$estudiant->fullname ?? null}}:
                </p>
                ...
                <ul style="text-transform: uppercase;">
                    ...
                    <li><span style="font-weight: bold">Fault</span>: {{$incident->fault ?? null}}</li>
                    <li><span style="font-weight: bold">Descripción</span>: {{$incident->description ?? null}}</li>
                    <li><span style="font-weight: bold">Descripción 1ra Instancia</span>: {{$incident->description_profesor ?? null}}</li>
                ...
                <p style="text-align: center;">{{$user->fullname ?? null}} <br> {{$user->rolname ?? null}}</p>
                <hr>
