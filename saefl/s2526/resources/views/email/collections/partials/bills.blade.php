<div style="text-align: right;">
        ...
        @if ($exchange_ammount_expire_bill > 0)
            <div>
                <h1>Para la fecha usted tiene una deuda de: <b style="font-size:1.8rem !important">$ {{f_float($exchange_ammount_expire_bill)}}</b></h1>
        ...
        @php
            ...
            $unexpire_bill = $representant->ExchangeUnexpireBillPendientes->first()
        @endphp
