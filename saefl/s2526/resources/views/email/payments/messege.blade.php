    ...
    <thead>
        <tr>
            <th scope="row" width="70px">
                <img width="70px" height="70px" class="card-img-top" src="https://saedev.uefrayluisamigosf.com/images/avatar/uecfla.jpg">
            </th>
            <th>
            ...
            <th scope="row" width="70px">
                <img width="100px" height="70px" class="card-img-top" src="https://saedev.uefrayluisamigosf.com/images/avatar/amigoniano.png">
            </th>
        </tr>
    </thead>
</table>
    ...
    <tbody>
        <tr>
            <td style="width: 100%;">
                ...
                {{-- @include('email.payments.partials.bills') --}}
