                    ...
                    <h4 class="mb-0 pb-0 border-bottom">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                {{-- <span class="font-weight-bold">Listado de profesores activos que pertenecen a las áreas de planificación</span> --}}
                                <span class="font-weight-bold">Listado de profesores activos.</span>
                            </div>
                        </div>
