    ...
    <div class="card-header  alert-dark">
        ...
        <h3 class="mb-0 pb-0">
            ...
            <div class="btn-group float-right pt-0 pb-2">                
                @include('livewire.academico.mailer.menu.index')                  
            </div>
        ...
        @include('livewire.academico.mailer.modals.helps')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="border rounded" style="{{(!$modeIndex) ? 'opacity: 0.8;filter:': null}}">
                        <h4 class="alert alert-secondary ">
                            Listado de mensajes registrados registrados.
                        </h4>
                        {{-- {{$mailers}} --}} 
                ...
                @if ($modeCreate)
                    <div class="col-7" >
                        <div>
                            <livewire:academico.mailer.create-component />
                        </div>
                    </div>
                @endif
                ...
                @if ($modeEdit)
                    <div class="col-7" >
                        <div>
                            <livewire:academico.mailer.edit-component :mailer="$mailer" :key="$mailer_id" />
                        </div>
                    </div>
                @endif
                    ...
                    <div class="col-7" >
                        <div class="border rounded shadow-lg">
                            <h5 class="alert alert-info font-weight-bolder rounded">
                                ...
                                <div class="px-2">
                                    {{-- @include('livewire.academico.mailer.table.partials.btnMode',['key'=>'preview'])                 --}}
                                </div>
                            </h5>
                            <hr>
                            <div class="p-1 m-1">
                                @if ($representant)
                                    @include('email.mailers.messege')                            
                                @else
                    ...
                    <div class="col-7" >
                        <div class="border rounded shadow-lg">
                            <h5 class="alert alert-dark font-weight-bolder rounded">
                                ...
                                <div class="px-2">
                                    {{-- @include('livewire.academico.mailer.table.partials.btnMode',['key'=>'show'])                 --}}
                                </div>
                            </h5>
                            ...
                            {{-- <hr> --}}
                            <div class="p-1 m-1">
                                @include('livewire.academico.mailer.table.show')
                            </div>
                        </div>
                    </div>
                @endif
