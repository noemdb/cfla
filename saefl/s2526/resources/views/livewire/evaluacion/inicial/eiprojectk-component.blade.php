                ...
                <tr class="">
                    ...
                    <td>
                        <div class="d-flex justify-content-start">
                            ...
                            <a title="Formato Proyecto" class="btn btn-dark btn-sm mr-1" href="{{route('evaluacions.eiprojectks.format.index',$item->id)}}" role="button" target="_BLANK">
