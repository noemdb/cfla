...
<nav>
    <div class="nav nav-tabs nav-fill font-weight-bold" id="nav-tab" role="tablist">
        ...
        <button class="nav-link p-1" id="nav-load-tab" data-bs-toggle="tab" data-bs-target="#nav-lesson" type="button" role="tab" aria-controls="nav-load" aria-selected="false"><i class="fas fa-book-reader" style="font-size: 1rem"></i> Lecciones</button>
...
<div class="tab-content border border-top-0 bg-white" id="nav-tabContent">
    ...
    {{--
        <div class="tab-pane fade" id="nav-incidents" role="tabpanel" aria-labelledby="nav-incidents-tab" tabindex="0">
