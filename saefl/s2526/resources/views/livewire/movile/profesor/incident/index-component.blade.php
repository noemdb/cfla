<div>
    <div class="card">
        ...
        <h5 class="card-title text-dark">Listado de incidencias</h5>
        <div class="card-body">
            <div class="text-start">
                ...
                <div class="small">
                    @forelse ($incidents->sortByDesc('created_at') as $incident)
                        @php
                                    ...
                                    <button type="button" class="accordion-button collapsed p-1">
                                        <div class="d-flex justify-content-between">
                                            <div class="ms-2 me-auto small">
                                                ...
                                                <span
                                                    class="small text-muted ms-2">{{ $incident->created_at->format('j \d\e M \d\e Y') }}</span>
