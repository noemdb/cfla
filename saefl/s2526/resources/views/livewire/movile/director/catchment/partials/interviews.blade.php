@php $uniqueId = 'interviews-chart-' . uniqid(); $total = $interviewsDays->sum(); $sortedDays = $interviewsDays->sortDesc(); @endphp
        ...
        <div class="d-flex flex-column h-100">  
            ...
            <div class="chart-header px-4 pt-4 pb-2">  
                <div class="d-flex justify-content-between align-items-center">  
                    <h6 class="mb-0 chart-title">  
                        ...
                        <span class="ms-2">Registros de Entrevistas por día</span>  
                    </h6>  
            ...
            <div class="chart-content flex-grow-1 px-4 py-3">  
                @foreach ($sortedDays as $key => $item)  
                    ...
                    @endphp  
                    <div class="chart-item {{ $isHidden ? 'd-none' : '' }}" data-interviews="{{ $loop->index }}">  
            ...
            @if ($sortedDays->count() > 4)  
                <div class="chart-footer px-4 py-3 border-top">  
                    <div class="d-flex justify-content-between align-items-center">  
                        ...
                        <button class="chart-toggle toggle-interviews">  
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    charts.forEach(chart => {  
        const toggleBtn = chart.querySelector('.toggle-interviews');  
        if (!toggleBtn) return;  
