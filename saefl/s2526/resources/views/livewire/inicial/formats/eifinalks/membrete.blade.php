    ...
    <thead>
        <tr class="text-center text-uppercase">
            <th scope="row" width="100px">
                <img width="100px" height="100px" class="card-img-top" src="{{ asset('images/avatar/uecfla.jpg') }}">
            </th>
            <th style="text-align: center;">
                ...
                <div class="text-muted pt-0 pb-0">
                    <b>Coordinación Académica, Educ. Inicial</b> <br>
                    <span>PERIODO ACADÉMICO {{ Session::get('pescolar_name') }}</span>
                </div>
                {{-- <div class="title"><b>PLAN DE EVALUACIÓN</b></div> --}}
            </th>
            <th scope="row" width="200px">
                <img width="200px" height="100px" class="card-img-top" src="{{ asset('images/avatar/amigoniano.png') }}">
            </th>
        </tr>
    </thead>
</table>
