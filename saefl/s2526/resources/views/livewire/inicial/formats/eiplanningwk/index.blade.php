...
<body>
    ...
    <!-- Membrete -->
    @include('livewire.inicial.formats.eiplanningwk.membrete')
    ...
    <table class="cabecera" class="format" width="100%" cellpadding="0" cellspacing="0" style="font-size:0.8rem;margin-bottom:0.2rem; padding-bottom:0.2rem;">
        ...
        <tr>
            <td colspan="2">
                <p><span>Diagnóstico </span>: {!! as_replace($eiplanningwk->diagnostico) !!}.</p>
            </td>
        </tr>
    </table>
    ...
    <table class="format" width="100%" cellpadding="0" cellspacing="0" style="font-size:0.8rem;margin-bottom:0.2rem; padding-bottom:0.2rem;">
        ...
        <tbody>
            @php
                ...
                $rowspan = $eiplanningwsummaries->count();
            @endphp
    ...
    @php $strategies = $eiplanningwk->eiplanningwstrategies()->get(); //dd($strategies); @endphp
        ...
        <tbody>
            ...
            <tr>
                ...
                @foreach($eiplanningwk->week_days as $day_key => $day_name)
                    <td>
                        @php
                            $estrategia = $eiplanningwk->getStrategyByMomentAndDay($momento_key, $day_key);
                        @endphp
