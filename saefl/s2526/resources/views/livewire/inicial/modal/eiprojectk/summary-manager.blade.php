<div>
    ...
    <div class="mb-4">
        ...
        @php
            $summaries = \App\Models\app\Inicial\Eiprojectk::find($eiprojectk_id)?->getOrderedSummaries() ?? collect();
        @endphp
        ...
        @else
            <div class="text-center py-4">
                ...
                <p class="text-muted small">Agrega el primer resumen para organizar los objetivos del proyecto.</p>
