    ...
    <div class="mb-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <button type="button" class="btn btn-success btn-sm" 
                    wire:click="openModal('strategy', {{ $eiprojectk_id }})">
                <i class="fas fa-plus mr-1"></i>Gestionar Estrategias
            </button>
        </div>

        @php
            $strategies = \App\Models\app\Inicial\Eiprojectk::find($eiprojectk_id)?->getOrderedStrategies() ?? collect();
        @endphp
        ...
        @else
            <div class="text-center py-4">
                ...
                <p class="text-muted small">Agrega estrategias para planificar las actividades del proyecto.</p>
