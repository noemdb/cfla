            ...
            <div class="modal-content" style="max-height: 90vh;">
                <div class="modal-header bg-primary text-white sticky-top">
                    <h5 class="modal-title">
                        @switch($modalType)
                            @case('create')
                                <i class="fas fa-plus mr-2"></i>Nuevo Plan Quincenal
                            @break

                            @case('edit')
                                <i class="fas fa-edit mr-2"></i>Editar Plan Quincenal
                            @break

                            @case('view')
                                <i class="fas fa-eye mr-2"></i>Detalles del Plan Quincenal
                            @break
                ...
                <div class="modal-body" style="max-height: calc(90vh - 120px); overflow-y: auto;">
                    @switch($modalType)
                        @case('create')
                        @case('edit')
                            @include('livewire.inicial.modal.eiplanningbwk.plan-form')
                        @break

                        @case('view')
                            @include('livewire.inicial.modal.eiplanningbwk.plan-details')
                        @break

                        @case('summary')
                            @include('livewire.inicial.modal.eiplanningbwk.summary-manager')
                        @break

                        @case('strategy')
                            @include('livewire.inicial.modal.eiplanningbwk.strategy-form')
                        @break

                        @case('edit-summary')
                            @include('livewire.inicial.modal.eiplanningbwk.summary-form')
                        @break
