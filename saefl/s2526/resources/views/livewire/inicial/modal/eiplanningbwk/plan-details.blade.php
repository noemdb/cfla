@php
    $plan = \App\Models\app\Inicial\Eiplanningbwk::with(['grado', 'seccion', 'eiprojectk', 'profesor'])->find($editingId);
    ...
    $weekDays = \App\Models\app\Inicial\Eiplanningbwstrategy::WEEK_DAYS ?? [
        'lunes' => 'Lunes',
        'martes' => 'Martes', 
        'miercoles' => 'Miércoles',
        'jueves' => 'Jueves',
    ...
    $moments = \App\Models\app\Inicial\Eiplanningbwstrategy::LIST_MOMENT ?? [
...
<div class="container-fluid">
            ...
            <div class="card border-secondary">
                <div class="card-header alert-secondary text-dark">
                    <h6 class="mb-0 font-weight-bold">
                        <i class="fas fa-info-circle mr-2"></i>Información General del Plan Quincenal
                    </h6>
                </div>
                <div class="card-body">
                    <div class="row">
    ...
    <!-- Strategies - INTEGRACIÓN DE EIPLANNINGBWSTRATEGIES -->
            ...
            <div class="col-12">
                <div class="card border-warning">
                    <div class="card-header bg-warning text-dark">
                        <h6 class="mb-0 font-weight-bold">
                            <i class="fas fa-users mr-2"></i>Estrategias Quincenales ({{ $strategies->count() }} elementos)
                        </h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-12">
                <div class="card border-light">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Este plan quincenal no tiene estrategias definidas para los momentos de rutina.</p>
            ...
            <div class="col-12">
                <div class="card border-light">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Este plan quincenal no tiene resúmenes ni estrategias registradas aún.</p>
                        <div class="mt-3">
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between">
                ...
                <div class="btn-group">
                    <a href="{{ route('inicials.eiplanningbwks.format.index', $plan->id) }}" 
