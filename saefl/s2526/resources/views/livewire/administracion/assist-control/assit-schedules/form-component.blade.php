<div>
    ...
    <div class="input-group">
        ...
        <div class="input-group-prepend">
            ...
            {!! Form::button($icon, [
                'wire:click' => 'editModeAssitScheduleOn(' . $assit_schedule_id . ')',
        ...
        {{-- <div class="input-group-prepend">
            ...
            {!! Form::button($icon,['wire:click'=>'createModeAssitScheduleOn','class'=>'input-group-text btn-primary','id'=>'edit']); !!}
        </div> --}}
    </div>
