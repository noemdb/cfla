        ...
        <div class="card-body">
            ...
            <div class="tab-content border border-top-0" id="nav-tabContent">
                <div class="tab-pane fade show active p-4 shadow" id="nav-{{$general}}" role="tabpanel" aria-labelledby="nav-{{$general}}-tab">
                    <livewire:administracion.assist-control.assit-schedules.form-component :id="$assit_schedule->id" :key="'assit-schedules-form-'.$assit_schedule->id" />
                </div>
                <div class="tab-pane fade p-4 shadow" id="nav-{{$days}}" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <livewire:administracion.assist-control.assit-week.main-component :id="$assit_schedule->id" :key="'assit-week-main'.$assit_schedule->id" />
                </div>
            </div>
