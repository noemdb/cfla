<div>
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            <thead>
                <tr>
                    <th wire:click="sortBy('id')" style="cursor: pointer;" class="sortable">
                        ID
                        @if($sortField === 'id')
                    ...
                    <th wire:click="sortBy('subject')" style="cursor: pointer;" class="sortable">
                        Asunto
                    ...
                    <th wire:click="sortBy('to')" style="cursor: pointer;" class="sortable">
                        Destinatario
                        @if($sortField === 'to')
                            @if($sortDirection === 'asc')
                                <i class="fa fa-sort-up"></i>
                    ...
                    <th wire:click="sortBy('created_at')" style="cursor: pointer;" class="sortable">
                        Fecha
                    ...
                    <th wire:click="sortBy('status')" style="cursor: pointer;" class="sortable">
                        Estado
                        @if($sortField === 'status')
                            @if($sortDirection === 'asc')
                                <i class="fa fa-sort-up"></i>
