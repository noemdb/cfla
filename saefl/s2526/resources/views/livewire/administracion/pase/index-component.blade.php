<div>
    ...
    <div class="pt-1 pb-0 px-1">
        <div class="d-flex justify-content-between alert alert-info">
            <div>
                <h3><i class="{{ $icon_menus['pases'] }} fa-1x text-success"></i> Gestión de Pases Escolares</h3>
            </div>
            <div>
    ...
    <!-- Filtros y Búsqueda -->
    @include('livewire.administracion.pase.form.filters')
                ...
                <div class="modal-content">
                    <form wire:submit.prevent="create">
                        ...
                        <div class="modal-body">
                            @include('livewire.administracion.pase.form.fields')
                        </div>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-4">
                        @include('livewire.administracion.pase.resumen-estudiantes')
