<div>
    ...
    <h4><u title="Listado especial con botones de acción">Listado</u> de <span class="font-weight-bolder">interacciones</span> registradas</h4>
            ...
            <div class="col">
                <div class="border rounded">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col">
                                @include('livewire.administracion.meta.chat.table.index')
                            </div>
                        </div>
                    </div>                   
