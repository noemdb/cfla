                        ...
                        <div class="row">
                            ...
                            <div class="col-{{ $modeIndex ? '12' : '5' }}"
                                ...
                                <div class="border rounded"
                                    ...
                                    @include('livewire.profesor.incident.agreement.table')
                                </div>
                            </div>
                            ...
                            @if ($modeCreate)
                                <div class="col-7">
                                    <div>
                                        @include('livewire.profesor.incident.agreement.form.create')
                                    </div>
                                </div>
                            @endif
                            ...
                            @if ($modeEdit)
                                <div class="col-7">
                                    <div>
                                        @include('livewire.profesor.incident.agreement.form.edit')
                                    </div>
                                </div>
                            @endif
                            ...
                            @if ($modeView)
                                <div class="col-7">
                                    <div>
                                        @include('livewire.profesor.incident.agreement.mode.viewMail')
                                    </div>
                                </div>
                            @endif
                            ...
                            @if ($modeClose)
                                <div class="col-7">
                                    <div>
                                        @include('livewire.profesor.incident.agreement.form.close')
                                    </div>
                                </div>
                            @endif
