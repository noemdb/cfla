<div>
    ...
    <div class="card-header  alert-dark mt-2">
        ...
        <h3 class="mb-0 pb-0">
            ...
            <span class=" font-weight-bold">Listado de descripciones tabuladas registradas.</span>
            ...
            <div class="row">
                ...
                <div class="col-{{ $modeIndex ? '12' : '3' }}" style="{{ !$modeIndex ? 'opacity: 0.3;' : null }}">
                    <div class="border rounded">
                        @include('livewire.bienestar.description.table.index')
                    </div>
                </div>
                ...
                @if ($modeEdit)
                    <div class="col-9">
                        <div style="background-color:white">
                            @include('livewire.bienestar.description.form.edit')
                        </div>
                    </div>
                @endif
                ...
                @if ($modeCreate)
                    <div class="col-9">
                        <div style="background-color:white">
                            @include('livewire.bienestar.description.form.create')
                        </div>
                    </div>
                @endif
