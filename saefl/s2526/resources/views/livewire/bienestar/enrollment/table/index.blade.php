                    ...
                    <td class="{{ $class_action ?? '' }}" id="btn-action-{{ $estudiant->id }}">
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            @if ($student_record)
                                ...
                                {{-- <a title="Editar datos de la ficha" class="btn btn-warning bnt-sm" href="#" wire:click="edit({{$id}})" role="button">
                            ...
                            @else
                                {{-- <a title="Crear ficha del estudiante" class="btn btn-primary bnt-sm" href="#" wire:click="create({{$estudiant->id}})" role="button">
