...
<head>
    ...
    <title>Plan de Actividades Por Grado {{ Session::get('pescolar_name') }}</title>
...
<body>
	...
	<div style="font-size: 1.2rem; font-weight: bold;" align="center">
	    Listado de Actividades de Planificación. PERIODO ACADÉMICO {{ Session::get('pescolar_name') }} <br>
	    <span class="small d-block p-0 m-0 " style="font-size: 0.8rem;">
	        P. Estudio: {{ $grado?->pestudio->name }} - Grado/Año {{ $grado->name }}
	    </span>
    ...
    @foreach($pensums as $pensum)
	    ...
	    $activities = $pensum->getActivities()
	    @endphp
