            ...
            <tr class="table-secondary">
                ...
                <th class="{{ $class_ci }} text-center">
                    ...
                    @foreach ($lapsos as $lapso)
                        <span class="text-center badge badge-{{ $lapso->class ?? secondary }} text-center" style="font-size: 0.6rem" title="{{$lapso->name}}">
                            {{ $lapso->code_sm }}
                        </span>
                    @endforeach
                </th>
                <th class="{{ $class_profesor }} text-center">
                    ...
                    @foreach ($lapsos as $lapso)
                        <span class="badge badge-{{ $lapso->class ?? secondary }} text-center" style="font-size: 0.6rem" title="{{$lapso->name}}">
                            {{ $lapso->code_sm }}
                        </span>
                    @endforeach
                </th>
