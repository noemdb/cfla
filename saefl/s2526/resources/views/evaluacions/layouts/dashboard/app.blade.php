@extends('evaluacions.layouts.app')
...
@section('body')
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 navbar-expand-md" style="background-color:#0c5460 !important">
        @include('evaluacions.layouts.dashboard.navbar.app')
    </nav>
    {{-- FIN navbar top --}}
        ...
        @if (Request::is('*home*'))
            <div class="row">
                <div class="col-md-2 d-md-block p-0 m-0 ">
                    @includeif('evaluacions.card.user')
                </div>
                <div class="col-md-10">
                    @yield('main')
                </div>
...
@section('footer') @include('evaluacions.layouts.footer.dashboard') @endsection
