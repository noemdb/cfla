@php
    $chart = [
        'range'=>'1',
        'id_chart'=>'registro_pagos_actividades_id_'.Auth::user()->id,
        'urlapi'=>route('academicos.charts.admon.bancos.actividades.chart'),
        'tipo'=>'line',
        'limit'=>6,
        'legend'=>true,
        'y_axes'=>'Cantidad',
...
@component('administracion.elements.card.panel')
    ...
    @slot('header','Cantidad diaria de registro de pagos')
