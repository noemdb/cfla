@php ($chart = ['range'=>'Todos','id_chart'=>'logdbsrolschart','urlapi'=>route('academicos.charts.audits.usages.logdbsrols'),'tipo'=>'bar','limit'=>6 ])
@section('scripts')
    @parent
...
@component('admin.elements.card.panel')
    ...
    @slot('header', 'Consultas a la BD del SAEFL por Roles')
