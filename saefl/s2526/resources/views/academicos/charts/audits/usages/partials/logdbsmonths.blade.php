@php ($chart = ['range'=>'Todos','id_chart'=>'logdbsmonthschart','urlapi'=>route('academicos.charts.audits.usages.logdbsmonths'),'tipo'=>'pie','limit'=>10 ])
@section('scripts')
    @parent
...
@component('admin.elements.card.panel')
    ...
    @slot('header', 'Consultas a la BD del SAEFL por Mes')
