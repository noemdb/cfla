@php ($chart = ['range'=>'Todos','id_chart'=>'loginoutsrolschart','urlapi'=>route('academicos.charts.audits.usages.loginoutsrols'),'tipo'=>'bar','limit'=>6 ])
@section('scripts')
    @parent
...
@component('admin.elements.card.panel')
    ...
    @slot('header', 'Accesos al SAEFL por Roles')
