    ...
    <main role="main">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-header p-0 m-0 mb-3">
                {!! Form::open([
                    'route' => 'academicos.inicials.index',
                    'method' => 'GET',
                    'class' => 'p-1 m-1',
                    'role' => 'search',
                ]) !!}
            ...
            <div class="card-body p-1 m-1">
                ...
                <nav>
                    <div class="nav nav-tabs nav-fill font-weight-bold" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-item nav-link disabled" id="nav-format2-tab" data-toggle="tab" href="#nav-format2"
                        ...
                        <a class="nav-item nav-link disabled" id="nav-format4-tab" data-toggle="tab" href="#nav-format4"
                            role="tab" aria-controls="nav-format4" aria-selected="false">Plan Especial</a>
                        <a class="nav-item nav-link disabled" id="nav-format5-tab" data-toggle="tab" href="#nav-format5"
                            role="tab" aria-controls="nav-format5" aria-selected="false">Plan de Evaluación</a>
                        <a class="nav-item nav-link disabled" id="nav-format6-tab" data-toggle="tab" href="#nav-format6"
                ...
                <div class="tab-content border border-top-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-format1" role="tabpanel"
                        ...
                        <div class="py-4 px-2">
                            @include('academicos.inicilas.table.eiplanningwks')
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="nav-format3" role="tabpanel" aria-labelledby="nav-format3-tab">
                        <div class="py-4 px-2">
                            @include('academicos.inicilas.table.eiprojectks')
                        </div>
