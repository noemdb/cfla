            ...
            <tr style="border-bottom: 0.4rem solid #c5c5c5">                
                ...
                <td>
                    ...
                    <div class="btn-group-vertical">
                        <a title="Formato Planificación semanal" class="btn btn-dark btn-sm mr-1" href="{{route('academicos.eiplanningwks.format.index',$item->id)}}" role="button" target="_BLANK">
