    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-toprint').click(function (e) {
                ...
                var url = '{{ route("profesors.edescriptivas.edescriptiva.pdf",["_id_"]) }}';
            ...
            $('.btn-modal-create').click(function (e) {
                ...
                var ajaxurl = '{{ route("profesors.ajax.fill.modal.edescriptiva.create", "_id_") }}';
            ...
            $('.btn-modal-details').click(function (e) {
                ...
                var container = '#container_modal';  //console.log(container);
                var ajaxurl = '{{route("profesors.ajax.fill.modal.edescriptiva.details", "_id_")}}';
                ajaxurl = ajaxurl.replace('_id_', id);
                $.ajax({
                    url: ajaxurl,
                    type: "GET",
