                ...
                <div class="d-flex">
                    ...
                    <div class="bg-light border-right collapsed" id="sidebarContainer"
                        ...
                        <div style="overflow-x: hidden; padding-top: 2.5rem;">
                            <nav class="nav flex-column">
                                ...
                                <a class="nav-link active d-flex align-items-center menu-item" href="#activities"
                                    data-partial="activities" data-route="{{ route('helpers.profesors.activities') }}"
                                    ...
                                    <i class="fas fa-book fa-1x" style="min-width: 20px; text-align: center;"></i>
                                    <span class="ml-2 nav-text">Actividades de Planificación</span>
                                </a>
                    ...
                    <div class="flex-fill" id="contentArea">
                        <div class="p-1" id="dynamicContent">
                            {{-- Contenido inicial --}}
                            @include('profesors.instructions.activities')
                        </div>
                    </div>
                </div>
            </div>
