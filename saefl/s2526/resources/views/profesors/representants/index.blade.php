    ...
    <main role="main">
        ...
        <div class="card card-primary mt-2">
            <div class="card-header alert-info">
                ...
                {{-- FIN Menu rapido --}}
                <h4>
                     <span title="Listado especial con botones de acción"><u>Listado</u></span> de Representantes de dstudiantes que pertenecen a la guiatura.
                </h4>
            </div>
            ...
            <div class="card-body">
                ...
                @include('profesors.representants.table.index')
