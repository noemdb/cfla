...
@if (!empty($pevaluacion->id))
    @component('elements.buttons.default')
        @slot('title', 'Carga de notas para ésta asignatura')
        @slot('class_bt', 'primary')
        @slot('route', route('administracion.boletins.carga',['grado_id'=>$grado_id,'seccion_id'=>$seccion_id,'lapso_id'=>$lapso_id,'pensum_id'=>$pensum_id]))
