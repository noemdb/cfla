@php ($chart = ['range'=>'Todos','id_chart'=>'inscr_aca_toxgeneroxgrado_id','urlapi'=>route('controls.charts.control.inscripcions.genderxgrado'),'tipo'=>'bar','limit'=>11,'legend'=>true,'y_axes'=>'Estudiantes','x_axes'=>'Grados'])
@section('scripts')
    @parent
