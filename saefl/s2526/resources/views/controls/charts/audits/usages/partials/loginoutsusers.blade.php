@php ($chart = ['range'=>'Todos','id_chart'=>'loginoutsuserschart','urlapi'=>route('controls.charts.audits.usages.usersxaccess'),'tipo'=>'line','limit'=>12 ])
@section('scripts')
    @parent
...
@component('controls.elements.card.panel')
    ...
    @slot('header', 'Accesos al SAEFL por Usuario')
