@extends('controls.layouts.dashboard.app')
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-header  alert-info">
                <div class="btn-group float-right pt-2">
                    @include('controls.boletins.menus.index')
                </div>
            ...
            <div class="card-body p-1 m-1">
                ...
                {!! Form::open(['route' => 'controls.boletins.index', 'method' => 'GET', 'class' => 'pb-3', 'role' => 'search']) !!}
                ...
                @include('controls.boletins.table.index')
            </div>
        </div>
    </main>
@endsection
