...
class CreateEispecialksTable extends Migration
{
    /**
     * Run the migrations. Informe Especial datos de cabecera
     *
     * @return void
     */
    public function up()
    {
        Schema::create('eispecialks', function (Blueprint $table) {
            ...
            $table->text('justificacion')->nullable(); // Justificación
    ...
    {
        Schema::dropIfExists('eispecialks');
    }
}
