...
class CreateEiplanningbwsummariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eiplanningbwsummaries', function (Blueprint $table) {
            $table->id(); // ID único para cada resumen
            $table->unsignedBigInteger('eiplanningbwk_id'); // Relación con la planificación semanal
    ...
    {
        Schema::dropIfExists('eiplanningbwsummaries');
    }
}
