...
class CreateEiprojectksTable extends Migration
{
    /**
     * Run the migrations. Proyecto de aula datos de cabecera
     *
     * @return void
     */
    public function up()
    {
        Schema::create('eiprojectks', function (Blueprint $table) {
            ...
            $table->date('finicial')->nullable(); // Fecha de inicio de la planificación
            $table->date('ffinal')->nullable(); // Fecha de culminación de la planificación
    ...
    {
        Schema::dropIfExists('eiprojectks');
    }
}
