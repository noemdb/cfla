...
class CreateReciboChangesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('recibo_changes', function (Blueprint $table) {
            ...
            $table->float('exchange_ammount',16,5)->nullable()->comment('Monto cambiario del vuelto');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('recibo_changes');
    }
}
