...
// Route::get('/planpagos/asignar/{id}', 'Tab\Configuracion\PlanPagoController@asignar')->name('administracion.configuraciones.planpagos.asignar');
// Route::post('/planpagos/set', 'Tab\Configuracion\PlanPagoController@set_plan')->name('administracion.configuraciones.planpagos.set.plan');
...
Route::delete('/configuraciones/planpagos/destroy/{id}', 'Tab\Configuracion\PlanPagoController@destroy')->name('administracion.configuraciones.planpagos.destroy');
