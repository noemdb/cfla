    ...
    'groups' => [
        ...
        'admin' => [
            ...
            'admin_only_items' => [
                ...
                [
                    'label' => 'URL Visitadas',
                    'route' => 'admin.binnacle.log.url',
                    'icon' => 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1',
                    'active' => 'admin.binnacle.log.url',
                ],
                [
                    'label' => 'Contenido LMS',
        ...
        'coordinacion' => [
            ...
            'items' => [
                ...
                [
                    'label' => 'Diagnósticos',
                    'route' => 'app.coordinacion.diagnosticos',
                    'icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
                    'active' => 'app.coordinacion.diagnosticos*',
                    'icon_color' => 'amber',
                ],
                [
        ...
        'seguimiento' => [
            'label' => 'Seguimiento',
            'icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
            'permission' => 'is_leadership',
            'color' => 'amber',
            'items' => [
                [
                    'label' => 'Dashboard',
                    'route' => 'app.leadership.dashboard',
                    'icon' => 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z',
                    'active' => 'app.leadership.dashboard',
                    'icon_color' => 'amber',
                ],
                [
                    'label' => 'Diagnóstico',
                ...
                [
                    ...
                    'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4',
                    'active' => 'app.leadership.activities*',
                    'icon_color' => 'amber',
                ],
                [
                    'label' => 'Lecciones',
                    'route' => 'app.leadership.lessons',
                    'icon' => 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z',
                    'active' => 'app.leadership.lessons*',
                    'icon_color' => 'amber',
                ],
                [
                    'label' => 'Profesores',
        ...
        'profesor' => [
            'label' => 'Profesor',
            'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
            'permission' => 'is_profesor_or_planner',
            'color' => 'emerald',
            'items' => [
                [
                    'label' => 'Dashboard',
