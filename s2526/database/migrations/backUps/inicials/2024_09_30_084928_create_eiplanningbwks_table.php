...
class CreateEiplanningbwksTable extends Migration
{
    /**
     * Run the migrations. Planificación quincenal datos de cabecera
     *
     * @return void
     */
    public function up()
    {
        Schema::create('eiplanningbwks', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('eiplanningbwks');
    }
}
