@php ($chart = ['range'=>'Todos','id_chart'=>'logdbsuserschart','urlapi'=>route('academicos.charts.audits.usages.logdbsusers'),'tipo'=>'line','limit'=>10 ])
@section('scripts')
    @parent
...
@component('admin.elements.card.panel')
    ...
    @slot('header', 'Consultas a la BD del SAEFL por Usuario.')
