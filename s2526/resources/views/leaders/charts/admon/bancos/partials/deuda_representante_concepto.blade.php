@php ($chart = ['range'=>'','id_chart'=>'deuda_representante_concepto','urlapi'=>route('academicos.charts.admon.bancos.deuda_representante_concepto'),'tipo'=>'line','limit'=>6,'legend'=>true,'x_axes'=>'Porcentaje','y_axes'=>'Concepto' ])
{{-- 'tipo'=>'horizontalBar' --}}
@section('scripts')
    @parent
