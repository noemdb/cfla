...
@endphp
                ...
                <tr data-id="{{$inscripcion->id ?? ''}}">
                    ...
                    <td class="{{ $class_action ?? '' }}" id="btn-action-{{ $estudiant->id }}">
                        ...
                        <div class="btn-group btn-group-sm">
                            <a class="btn btn-primary" href="{{route('representants.inscripciones.constancia.prosecucion.pdf',$estudiant->id)}}" target="_blank" role="button">
    ...
    {!! Form::open(['route' => ['representants.inscripciones.destroy',':IDENT_ID'], 'method' => 'DELETE', 'id'=>'form-destroy', 'role'=>'form']) !!}
