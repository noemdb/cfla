    ...
    <main role="main" class="col-md-10 col-lg-10">
        ...
        <div class="card card-primary mt-2">
            <div class="card-header pb-0 mb-0 alert-secondary">
                <h3>
                    <i class="{{ $icon_menus['preinscripcions'] }} fa-1x text-success"></i>
                    Búsqueda de Preinscripciones
                    {{-- INI Menu rapido --}}
                    <div class="btn-group float-right">

                        {{-- @include('representants.preinscripcions.menus.index') --}}
            ...
            <div class="card-body">
                ...
                {!! Form::open([
                    'route' => 'representants.preinscripcions.index',
                    'method' => 'GET',
                    'class' => '',
                    'role' => 'search',
                ]) !!}
                ...
                @isset($inscripcions)
                    ...
                    @include('representants.preinscripcions.deck.inscripcion')
