@php ($chart = ['range'=>'','id_chart'=>'estudiants_municipios_pestudio','urlapi'=>route('directors.charts.control.estudiants.estudiants_municipios_pestudio'),'tipo'=>'bar','limit'=>6,'legend'=>true,'y_axes'=>'Estudiantes','x_axes'=>'Plan Educativo'])
@section('scripts')
    @parent
