@php ($chart = ['range'=>'Todos','id_chart'=>'estudiants_municipios','urlapi'=>route('bienestars.charts.control.estudiants.estudiants_municipios'),'tipo'=>'pie','limit'=>6 ])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Distribución de estudiantes por su municipio natal.')
