        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 px-1 my-1">
            <div class="card h-100 mb-1">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        @include('bienestars.incidents.partials.details.profesors')
                        {{-- /home/nuser/code/s2223/resources/views/bienestars/incidents/partials/details/profesors.blade.php --}}
                    </p>
                    {{-- <p class="card-text text-right"><small class="text-muted">Last updated 3 mins ago</small></p> --}}
                </div>
            </div>
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 px-1 my-1">
            <div class="card h-100 mb-1">
                <div class="card-body">
                    ...
                    <div class="text-muted font-weight-bold small"> ¿Que docentes estan más relacionados al registro de incidencias? </div>
                    <p class="card-text">
                        @include('bienestars.incidents.partials.details.estudiant')
                    </p>
                </div>
            </div>
        </div>
