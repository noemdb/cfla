<table border="1" width="100%" class="table-signal" cellpadding="1" cellspacing="1">
  <thead>
    <tr>
      <th align="left" style="width: 30% !important">VIII. Fecha de Remisión: 
        <span class="small-90" style="padding-left:0.2cm;text-transform: capitalize;">
        {{ $fecha_remision->format('d-m-Y') ?? '' }}</span>
      </th>
      ...
      <td style="width: 30% !important">IX. Fecha de Recepción</th>
    ...
    <tr>
      <td style="font-weight: bold">{{ $autoridad1->ci ?? ''}}</td>
      <td></td>
    </tr>
    <tr>
