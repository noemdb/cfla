@php ($chart = ['range'=>1,'id_chart'=>'time_id_'.Auth::user()->id,'urlapi'=>route('administracion.inscripcion.time.chart'),'tipo'=>'line','limit'=>10,'legend'=>true,'y_axes'=>'Cant. Estudiantes','x_axes'=>'Días'])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header','Distribución diaria de la cantidad de inscripciones')
