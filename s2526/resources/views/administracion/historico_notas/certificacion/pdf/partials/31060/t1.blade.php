<table cellpadding="4" cellspacing="4" width="100%" style="text-transform: uppercase;">
  <tbody>
    <tr>
      <td colspan="7" rowspan="3">
        <img alt="{{$inscripcion->logo ?? ''}}" height="30px" src="{{ asset('images/brand/gob/logo.png') }}">
      </td>
      <th colspan="16" align="center" class="uline">CERTIFICACI&Oacute;N DE CALIFICACIONES EMGCT</th>
    </tr>
    <tr>
