<div class="card">
    ...
    <div class="card-body">
        ...
        {!! Form::model($inscripcion,['route' => ['administracion.enrollments.update', $inscripcion->id], 'method' => 'PUT', 'id'=>'form-update_'.$inscripcion->id, 'role'=>'form']) !!}
            @include('administracion.enrollments.form.fields.grupo_estable')
