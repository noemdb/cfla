...
<div class="form-group">
    <label for="abono_description" class=" m-0  font-weight-bold text-muted">Descripción</label>
    {!! Form::text('abono_description', old('abono_description'), [
        'class' => 'form-control',
        'placeholder' => 'Descripción',
        'id' => 'abono_description',
    ]) !!}
</div>
