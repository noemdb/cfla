@php ($chart = ['range'=>1,'id_chart'=>'actividades_id_'.Auth::user()->id,'urlapi'=>route('administracion.evaluacions.actividades.chart'),'tipo'=>'line','limit'=>10,'legend'=>true,'y_axes'=>'Cantidad de Evaluaciones','x_axes'=>'Días'])
@section('scripts')
    @parent
