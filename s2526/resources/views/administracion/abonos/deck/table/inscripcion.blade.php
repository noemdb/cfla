    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <div class="btn-group-vertical btn-block" role="group" aria-label="Basic example">
                <a title="Constancia Inscripción" class="btn btn-info btn-sm btn-block" target="_blank" href="{{ route('administracion.registropagos.constancia.pdf',$inscripcion->estudiant_id) }}" role="button">
                    C. Inscripción
                </a>
                {{-- <a class="btn btn-info btn-sm btn-block" target="_blank" href="{{ route('administracion.registropagos.constancia.estudio.pdf',$inscripcion->estudiant_id) }}" role="button">
                    Constancia Estudio
                </a> --}}
            </div>            
        </div>
