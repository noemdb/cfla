<div class="card-header p-0 m-0 mb-3">
    ...
    <div class="form-row font-weight-bold">
        ...
        <div class="col-3">Asignatura</div>
        <div class="col-3">Profesores</div>
    </div>
    <div class="form-row">
        <div class="col-2">
    ...
    <div class="form-row pt-2">
        ...
        <div class="col-1">
            <label for="ffinal" class="font-weight-bold m-0">Buscar</label>
            <div class="btn-group btn-group-sm btn-block">
                <button class="btn btn-primary" type="submit">
                    <i class="fa fa-search" aria-hidden="true"></i>
                    {{-- Buscar --}}
                </button>
                {{-- <a name="" id="" class="btn btn-light" href="{{url()->current()}}" role="button" title="Refrescar la página'">
