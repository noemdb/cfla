  ...
  <div class="form-group">
      <label for="description" class="m-0 font-weight-bold text-muted">Estrategia / Descripción</label>
      {!! Form::text('description', old('description'), [
          'class' => 'form-control',
          'placeholder' => 'Estrategia / Descripción',
          'id' => 'Descripción',
          'required',
      ]) !!}
  </div>

  {{-- @includeWhen((Request::is('*create*')), 'administracion.pevaluacions.evaluacions.form.partials.create.escala_id') --}}
  {{-- @includeWhen((equest::is('*edit*')), 'administracion.pevaluacions.evaluacions.form.partials.edit.escala_id') --}}
