@php ($chart = ['range'=>'','id_chart'=>'estudiants_municipios_pestudio','urlapi'=>route('administracion.estudiants.municipio.pestudio.chart'),'tipo'=>'bar','limit'=>6,'legend'=>true,'y_axes'=>'Cantidad','x_axes'=>'Mes' ])
@section('scripts')
    @parent
