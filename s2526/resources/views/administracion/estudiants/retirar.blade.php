        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-body">
                ...
                @include('admin.elements.messeges.oper_ok') 
                    ...
                    {{-- @include('administracion.estudiants.table.retirar') --}}

            </div>
        </div>
    </main>
    {!! Form::open(['route' => ['administracion.estudiants.set.retirar',':ESTUDIANT_ID'], 'method' => 'POST', 'id'=>'form-retirar', 'role'=>'form']) !!}
    {!! Form::close() !!}
    @section('scripts')
        @parent
        <script src="{{ asset("js/models/estudiants/retirar.js") }}"></script>
    @endsection
@endsection
