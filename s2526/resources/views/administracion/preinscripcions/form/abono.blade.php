<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-7">
                {!!Form::open(['route'=>'administracion.preinscripcions.abono.store','method'=>'POST','id'=>'form-abono-store-'.$prepago->id,'class'=>'form-signin'])!!}
                    @include('administracion.preinscripcions.form.fields.abono')
            ...
            <div class="col-5">
                @include('administracion.preinscripcions.show.representant.resume')
            </div>
...
<script type="text/javascript">
    //ini del evento clic
     $('.btn-abono-store').click(function (e) {
         ...
         var url = "{{ route('administracion.preinscripcions.abono.store') }}"; //console.log(url);
