...
<div class="form-group">
    <label for="exchange_ammount_late_payment" class="m-0">Monto Cambiario Extemporaneo del Pago <span
            class="text-muted small">[Decimales separados por punto]</span></label>
