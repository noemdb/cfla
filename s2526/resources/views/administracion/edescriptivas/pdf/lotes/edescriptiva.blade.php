...
<body>
    ...
    @foreach ($estudiants as $estudiant)
        ...
        @php $edescriptivas = $estudiant->edescriptivas->where('lapso_id',$lapso_id); @endphp

        @if ($edescriptivas->count())
            ...
            @foreach ($edescriptivas as $edescriptiva)
                ...
                @if ($lapso)
                    ...
                    @includeIf('administracion.edescriptivas.pdf.partials.lapso.main')

                @else

                    @includeIf('administracion.edescriptivas.pdf.partials.final.main')
