    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-header pb-0 mb-0 alert-secondary">
                ...
                <h3>Guía instruccional, <span class="font-weight-bolder">Recolección de Marcajes.</span> <span class=" text-muted small">Registros de huellas dáctilares</span>  </h3>
            </div>
            ...
            <div class="card-body">
                ...
                @include('administracion.asisst_controls.assit_attendances.help.collectCSV')
