        ...
        <div class="card card-primary mt-2">
            <div class="card-header pb-0 mb-0 alert-secondary">
                <h4>
                    ...
                    Imprimir listado de estudiantes con inscripciones administrativas (PDF)
            ...
            <div class="card-body">
                ...
                {{-- @isset($pestudios)
                    ...
                    @include('administracion.inscripciones.book.pestudios')                        
                @endisset
                
                @isset($grados)
                    <h5>Grados</h5>
                    @include('administracion.inscripciones.book.grados')                        
                @endisset

                @isset($tinscripcions)
                    <h5>TIPO DE INSCRIPCIÓN</h5>
                    @include('administracion.inscripciones.book.tinscripcions')                        
                @endisset --}}
