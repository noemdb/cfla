@component('elements.buttons.default')
    @slot('title', 'Listado de Instituciones')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.oinstitucions.index'))
    @slot('icon', $icon_menus['crud'])
@endcomponent
@component('elements.buttons.default')
    @slot('title', 'Crear nueva Institución')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.configuraciones.oinstitucions.create'))
