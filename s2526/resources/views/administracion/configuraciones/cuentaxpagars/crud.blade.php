        ...
        <div class="card card-primary mt-2">
            <div class="card-header  alert-info">
                <h4>
                    ...
                    <span title="Listado especial con botones de acción"><u>Listado</u></span> de Conceptos de Cobro
            ...
            <div class="card-body">
                ...
                @include('administracion.configuraciones.cuentaxpagars.table.crud')  

            </div>
        </div>
    </main>
    {!! Form::open(['route' => ['administracion.configuraciones.cuentaxpagars.destroy',':CUENTASXCOBRAR_ID'], 'method' => 'POST', 'id'=>'form-retirar', 'role'=>'form']) !!}
    {!! Form::close() !!}
    @section('scripts')
        @parent
        <script src="{{ asset("js/models/cuentaxpagars/delte.js") }}"></script>
    @endsection
@endsection
