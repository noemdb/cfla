    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary mt-2">
            <div class="card-header alert-secondary">
                <h4>Actualizar concepto de cobro <span class=" font-weight-bolder">{{$cuentaxpagar->name ?? ''}}</span></h4>
            </div>
...
@section('scripts') @parent <script type="text/javascript"> document.title = 'SAEFL - Conceptos de Cobro, actualizar'; </script> @endsection
