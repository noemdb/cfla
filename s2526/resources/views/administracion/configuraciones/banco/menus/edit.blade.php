@component('elements.buttons.default')
    @slot('title', 'Listado')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.profesors.index'))
    @slot('icon', $icon_menus['crud'])
@endcomponent

@component('elements.buttons.default')
    @slot('title', 'Crear nuevo profesor')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.configuraciones.profesors.create'))
