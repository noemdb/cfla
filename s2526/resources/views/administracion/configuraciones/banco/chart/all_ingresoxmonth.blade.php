@php ($chart = ['range'=>'3','id_chart'=>'ingresoxmonth_id_'.Auth::user()->id,'urlapi'=>route('administracion.configuraciones.bancos.ingresoxmonth.chart'),'tipo'=>'line','limit'=>6 ])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Ingresos registrados por mes')
