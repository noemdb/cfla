...
<div class="modal fade" id="CreateNomConceptModal" tabindex="-1" role="dialog" aria-labelledby="CreateNomConceptModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form class="form-signin" action="{{ route('administracion.ajax.modal.create.nom_concepto') }}" method="POST" id="registerForm">
            <div class="modal-header alert-secondary">
                <h5 class="modal-title" id="CreateNomConceptModalLabel">Nuevo nombre para la cuenta de cobro</h5>
            ...
            <div class="modal-body">                 
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Nombre" aria-label="Nombre" aria-describedby="button-addon2" id="name" name="name">
