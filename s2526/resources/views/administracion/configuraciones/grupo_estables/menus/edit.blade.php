@component('elements.buttons.default')
    @slot('title', 'Listado de grupo_estables')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.grupo_estables.index'))
    @slot('icon', $icon_menus['crud'])
@endcomponent
@component('elements.buttons.default')
    @slot('title', 'Crear nueva grupo_estable')
    @slot('class_bt', 'primary')
    @slot('route', route('administracion.configuraciones.grupo_estables.create'))
