@component('elements.buttons.default')
    @slot('title', 'Asignar Plan Benéfico')
    @slot('class_bt', 'success')
    @slot('route', route('administracion.configuraciones.plan_beneficos.index'))
    @slot('icon', $icon_menus['nuevo'])
@endcomponent
@component('elements.buttons.default')
    @slot('title', 'Listado de Planes Asignados')
    @slot('class_bt', 'light')
    @slot('route', route('administracion.configuraciones.plan_beneficos.crud'))
