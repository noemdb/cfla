    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-header pb-0 mb-0 alert-secondary">
                ...
                <h4><u title="Listado especial con botones de acción">Listado</u> de las <span class="font-weight-bolder">Políticas de Cobranza</span> registradas</h4>
            </div>

            <div class="card-body">

                @include('administracion.collections.coll_politicals.table.crud')
