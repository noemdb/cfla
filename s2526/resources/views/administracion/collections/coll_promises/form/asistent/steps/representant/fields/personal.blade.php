@php
    $stepShow = [
        'up'=>'step-representant-contact',
        // 'dowm'=>'step-coll_promises-coll_political_id',
        'dowm'=>'step-start',
    ] ;
    $stepId = "step-representant-personal";
@endphp
...
<div class="first-of-type" id="{{$stepId}}">
    <div class="alert alert-secondary rounded flex-center px-4 py-2"  style="min-height: 25rem;">
        <div>
            ...
            @include('administracion.collections.coll_promises.form.asistent.steps.representant.partials.personal')
        </div>
    </div>
