@php
    $stepShow = [
        'up'=>'step-representant-bill',
        'dowm'=>'step-representant-ident-1',
    ] ;
    $stepId = "step-representant-ident-2";
@endphp
...
<div class="first-of-type" id="{{$stepId}}">
    <div class="alert alert-secondary rounded flex-center px-4 py-2"  style="min-height: 25rem;">
        <div>
            @include('administracion.collections.coll_promises.form.asistent.steps.representant.partials.ident2')
        </div>
    </div>
