    ...
    <main role="main" class="col-md-10 col-lg-10">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-body">
                ...
                {!! Form::open([
                    'route' => 'administracion.registropagos.list.pdf',
                    'method' => 'POST',
                    'class' => '',
                    'role' => 'search',
                    'target' => '_blank',
                ...
                {{-- @isset($pestudios)
                    ...
                    @include('administracion.registropagos.book.pestudios')                        
                @endisset
                
                @isset($grados)
                    <h5>Grados</h5>
                    @include('administracion.registropagos.book.grados')                        
                @endisset

                @isset($tinscripcions)
                    <h5>TIPO DE INSCRIPCIÓN</h5>
                    @include('administracion.registropagos.book.tinscripcions')                        
                @endisset --}}
