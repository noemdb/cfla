...
@section('title')
    Asistente Interactivo para el registro de deudas individuales - {{ Auth::user()->rol ?? '' }}
@endsection
...
@section('main')
    <main role="main" class="col-md-10 col-lg-10">
        ...
        <div class="p-2 m-2">
            ...
            <livewire:administracion.estudiants.asistente-deuda-individual-component />
...
@section('sweetalert')
    ...
    <script>
        ...
        window.addEventListener('swal:confirmacion-cambio-planpago', function(e){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Usuario confirmó el cambio, proceder con la creación
                    window.livewire.emit('confirmarCambioPlanPago', 
                        e.detail.planpago_actual_id, 
                        e.detail.planpago_nuevo_id
                    );
                } else {
                    // Usuario canceló, mostrar mensaje informativo
                    Swal.fire({
                        title: 'Operación Cancelada',
                        text: 'La creación de la deuda ha sido cancelada. El plan de pago no fue modificado.',
                        icon: 'info',
