    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        ...
        <div class="card card-primary mt-2">
            ...
            <div class="card-header  alert-secondary">
                ...
                <h4><b class="text-dark">Informe de notas</b> por lapso</h4>
            ...
            <div class="card-body bd-callout bd-callout-{{$grado->color ?? 'default'}} p-2 m-2">
                ...
                @include('administracion.boletins.form.search.boletin',[
                    'route'=>'administracion.boletins.boletin',
                    'required_seccion'=>true,
                    'btn_toprint_lote'=>'true'])

                @include('administracion.boletins.table.boletin')
    ...
    <script>
        ...
        $(document).ready(function() {
          $('#btn_toprint_lote').click(function (e) {
              ...
              var url = '{{ route('administracion.boletins.boletin.lote.pdf',["_gid_","_sid_","_lid_"]) }}';
