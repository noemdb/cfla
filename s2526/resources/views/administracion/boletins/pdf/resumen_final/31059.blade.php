...
@foreach ($estudiants_chunks as $estudiants)
    ...
    <div class="page">
        ...
        @include('administracion.boletins.pdf.resumen_final.partials.31059.t1')
        @include('administracion.boletins.pdf.resumen_final.partials.31059.t2')
        @include('administracion.boletins.pdf.resumen_final.partials.31059.t3')
        @include('administracion.boletins.pdf.resumen_final.partials.31059.t4')
        @include('administracion.boletins.pdf.resumen_final.partials.31059.t5')
