<div>
{{-- <div style="align-content: center !mportant;text-align: center !mportant;align-items: center !mportant;"> --}}

    <table border="1" cellpadding="0" cellspacing="0" width="98%" class="table-list" class="text_small" style="width: 98% !important;">
        <thead>
        <tr>
        ...
        <tr align="center" style="font-weight: bold">
            ...
            {{-- <td colspan="1" class="td_" rowspan="2">&nbsp;</td> --}}
        ...
        @foreach ($estudiants as $estudiant)
            ...
            @endphp
            <tr>
                <td style="width: 10px !important;">{{ str_pad($count_item, 2, "0", STR_PAD_LEFT) ?? ''}}</td>
                ...
                @foreach ($pensums as $pensum)
                    @php
                        ...
                        // if ($escolaridad==1) { $count_arr_in[$pensum->id]++; }
                        ...
                        // if ($nota_final < $aprobacion && !empty($nota_final )) { $count_arr_ar[$pensum->id]++; }
                        if ($nota_final < $aprobacion && ($escolaridad == 1 )) { $count_arr_ar[$pensum->id]++; }
                        ...
                        // if (empty($nota_final )) { $count_arr_nc[$pensum->id]++; }
                ...
                @endforeach
                <td class="td-nowrap text_small" align="center">{{$estudiant->grupo_estable->name ?? null}} </td>
            </tr>
        @endforeach
