@php ($chart = ['range'=>'1','id_chart'=>'actividades_id_'.Auth::user()->id,'urlapi'=>route('academicos.evaluacions.actividades.chart'),'tipo'=>'line','limit'=>6,'legend'=>true,'y_axes'=>'Estudiantes','x_axes'=>'Plan Educativo'])
@section('scripts')
    @parent
...
@component('academicos.elements.card.panel')
    ...
    @slot('body')
        @component('academicos.elements.canvas.chart')
