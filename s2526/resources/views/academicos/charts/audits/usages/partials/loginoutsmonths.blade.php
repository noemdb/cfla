@php ($chart = ['range'=>'Todos','id_chart'=>'loginoutsmonthschart','urlapi'=>route('academicos.charts.audits.usages.loginoutsmonths'),'tipo'=>'pie','limit'=>6 ])
@section('scripts')
    @parent
...
@component('admin.elements.card.panel')
    ...
    @slot('header', 'Accesos al SAEFL por Mes')
