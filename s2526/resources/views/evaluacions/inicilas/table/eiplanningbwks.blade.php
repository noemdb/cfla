            ...
            <tr style="border-bottom: 0.4rem solid #c5c5c5">                
                ...
                <td>
                    ...
                    <div class="btn-group-vertical">
                        <a title="Formato Planificación Quincenal" class="btn btn-dark btn-sm mr-1" href="{{route('evaluacions.eiplanningwks.format.index',$item->id)}}" role="button" target="_BLANK">
                            <i class="{{ $icon_menus['pdf'] ?? '' }} fa-1x"></i>
                        </a>
                        <a title="Formato Planificación Quincenal" class="btn btn-dark btn-sm mr-1" href="{{route('evaluacions.eiplanningwks.format.index',$item->id)}}" role="button" target="_BLANK">
                            <i class="{{ $icon_menus['register'] ?? '' }} fa-1x"></i>
                        </a>
                    </div>
