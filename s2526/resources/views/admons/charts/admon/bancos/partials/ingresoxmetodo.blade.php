@php ($chart = ['range'=>'','id_chart'=>'ingresoxmetodo','urlapi'=>route('directors.charts.admon.bancos.ingresoxmetodo'),'tipo'=>'bar','limit'=>6,'legend'=>true,'x_axes'=>'Porcentaje','y_axes'=>'Concepto' ])
{{-- 'tipo'=>'horizontalBar' --}}
@section('scripts')
    @parent
