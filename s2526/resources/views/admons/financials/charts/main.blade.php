    ...
    <div class="tab-content border border-top-0" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-6">
                        @include('directors.charts.admon.bancos.ingresoxmetodo')
                    </div>
                    <div class="col-xl-6">
                        @include('directors.charts.admon.payments.countxday')
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-10 offset-xl-1" data-toggle="modal">
                        @include('directors.charts.admon.exchange_rates.fluctuations')
                    </div>
                </div>
            </div>
        </div>
...
<div class="row p-1">
    <div class="col-xl-10 offset-xl-1" data-toggle="modal">
        @include('directors.charts.admon.registropagos.actividades')
    </div>
</div>
