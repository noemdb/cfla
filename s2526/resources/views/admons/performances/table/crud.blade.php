            ...
            class="table-{{(empty($pevaluacion->administrativa->id)) ? 'default':'success'}}">
                ...
                <td class="{{ $class_action ?? '' }}" id="btn-action-{{ $pevaluacion->id }}">
                    <div class="btn-group">
                        ...
                        <a title="Editar" class="btn {{$class_btn ?? ''}} {{$disabled ?? ''}}"  href="{{route('directors.pevaluacions.edit',$pevaluacion->id)}}" role="button">
                        ...
                        <a title="Exportar las evaluaciones de éste plan y asignarlas a otra sección" class="btn-clone btn {{$class_btn ?? ''}} {{$disabled ?? ''}}" href="{{route('directors.evaluacions.create_clone',$pevaluacion->id)}}" role="button">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            ...
                            <a title="Registrar Evaluaciones" class="dropdown-item" href="{{route('directors.evaluacions.create',$pevaluacion->id)}}" role="button">
                            ...
                            <a title="Registro de Notas" class="dropdown-item" href="{{route('directors.boletins.carga',['pevaluacion_id'=>$pevaluacion->id])}}" role="button">
...
{{-- {!! Form::open(['route' => ['directors.pevaluacions.store_clone',':PEVALUCION_ID'], 'method' => 'POST', 'id'=>'form-clone', 'role'=>'form']) !!} --}}
{{-- {!! Form::close() !!} --}}
{{-- @section('scripts') @parent <script src="{{ asset("js/models/pevaluacions/clone.js") }}"></script> @endsection --}}

{!! Form::open(['route' => ['directors.pevaluacions.destroy',':PEVALUCION_ID'], 'method' => 'DELETE', 'id'=>'form-destroy', 'role'=>'form']) !!}
{!! Form::close() !!}
