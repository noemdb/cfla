                ...
                <td class="{{ $class_action ?? '' }}">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        @component('elements.widgets.modal')
                            ...
                            @slot('size','modal-md')
                            @slot('body')
                                {{-- @include('profesors.edescriptivas.partials.details') --}}
                            @endslot
                        @endcomponent
                        ...
                        @component('elements.widgets.modal')
                            ...
                            @slot('size','modal-md')
                            @slot('body')
                            {{-- @include('profesors.edescriptivas.partials.edit') --}}
                            @endslot
                        @endcomponent
...
{!! Form::open(['route' => ['profesors.edescriptivas.destroy',':IDENT_ID'], 'method' => 'DELETE', 'id'=>'form-destroy', 'role'=>'form']) !!}
