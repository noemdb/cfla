                ...
                <div class="content">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card shadow p-1 mb-5 bg-white rounded">
                                <div class="card-body p-1 m-1">
                                    ...
                                    <div class="dropdown-divider mb-0"></div>
                                    {!! Form::open([
                                        'route' => 'profesors.evaluacions.store',
                                        'method' => 'POST',
                                    ...
                                    <div class="btn-group btn-block" role="group" aria-label="Basic example">
                                        <button type="submit" class="btn-pevaluacions-create btn btn-info"
                                        ...
                                        <a class="btn btn-primary" href="{{ route('profesors.evaluacions.index') }}"
                                            role="button">
                                            <i class="far fa-save"></i> Finalizar
                                        </a>
                                    </div>
                        ...
                        @if (!empty($pevaluacion->evaluacions->first()))
                            <div class="col-sm-3">
                                <div
                                    class="h-100 rounded p-1 m-1 alert-{{ $pevaluacion->status_eva_complete ? 'success' : 'warning' }}">
                                    <h5 class="card-title">Lista de Evaluaciones registradas</h3>
                                        ...
                                        @includewhen(
                                            $evaluacions,
                                            'profesors.pevaluacions.partials.evaluacion')
                                </div>
                            </div>
                        @endif
