        ...
        <tbody id="tdatos">
            ...
            @foreach ($estudiants as $estudiant)
                @php
                    ...
                    $value = isset($notasXlsCol[$estudiant->gsemail]) ? $notasXlsCol[$estudiant->gsemail] : null;
                    $data = collect();
                    $data->put('id', $estudiant->id);
                    $data->put('gsemail', $estudiant->gsemail);
                ...
                <tr data-id="{{ $estudiant->id }}"
                    ...
                    <td id="td-users-username-{{ $estudiant->id }}" class="{{ $class_user ?? '' }}">
                        {{ $estudiant->fullname }}
                        <div class="small">{{ $estudiant->gsemail ?? '' }}</div>
                    </td>
...
{{-- @include('profesors.datatables.simple') --}}
