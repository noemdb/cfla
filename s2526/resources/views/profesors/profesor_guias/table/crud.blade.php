                ...
                <td class="{{ $class_action ?? '' }}">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        @component('elements.widgets.modal')
                            ...
                            @slot('size','modal-md')
                            @slot('body')
                                {{-- @include('profesors.profesor_guias.partials.details') --}}
                            @endslot
                        @endcomponent
                        ...
                        @component('elements.widgets.modal')
                            ...
                            @slot('size','modal-md')
                            @slot('body')
                            {{-- @include('profesors.profesor_guias.partials.edit') --}}
                            @endslot
                        @endcomponent
...
{!! Form::open(['route' => ['profesors.profesor_guias.destroy',':IDENT_ID'], 'method' => 'DELETE', 'id'=>'form-destroy', 'role'=>'form']) !!}
