@php ($chart = ['range'=>'1','id_chart'=>'actividades_id_'.Auth::user()->id,'urlapi'=>route('controls.evaluacions.actividades.chart'),'tipo'=>'line','limit'=>6,'legend'=>true,'y_axes'=>'Estudiantes','x_axes'=>'Plan Educativo'])
@section('scripts')
    @parent
...
@component('controls.elements.card.panel')
    @slot('class', 'success')
    ...
    @slot('body')
        @component('controls.elements.canvas.chart')
