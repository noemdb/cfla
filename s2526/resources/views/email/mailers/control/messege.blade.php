            ...
            <td style="width: 100%;">
                ...
                @if ($mailer)
                    ...
                    <p style="text-align: justify;">
                        Estimado(a) Sr(a).&nbsp;<em><strong>{{$representant->name_full}}</strong>, CI; {{$representant->ci_representant}},</em>
                    </p>

                    @php $address = ($representant) ? $representant->address : $representant->dir_address;  @endphp
                    ...
                    <div style="text-align: justify; padding-left: 1rem; padding-botton: 1rem;margin-bottom: 1rem">
                        ...
                        <div style="padding-left: 1rem; margin-top: 0rem">
                            ...
                            {{-- @php $estudiants = ($representant) ? $representant->getNotificableFormalyEstudiants() : collect(); @endphp --}}
