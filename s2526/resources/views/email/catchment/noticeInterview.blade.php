        ...
        <tr>
            <td style="width: 100%;">
                ...
                @if ($catchment)
                    ...
                    <h3>¡Bienvenido(a) al proceso de Matriculación Escolar 2025-2026!</h3>
                    ...
                    <p>
                        En nombre del <strong>{{$institucion->name ?? null}}</strong>, les damos la bienvenida al proceso de matrícula escolar 2025-2026. 
                    ...
                    <p>
                        Es un gusto saludarle. Le recordamos que su entrevista está pautada para el 
                        {{f_date($catchment->day_appointment) ?? null}} a las 2pm. Su presencia es muy importante para nosotros, ya que nos permite fortalecer el trabajo en equipo por la educación de su representado/a.  
                    </p>
