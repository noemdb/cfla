<div class="border rounded">
	...
	@switch($step)
	    @case('1')@include('livewire.general.enrollment.form.enrollment.estudiant')@break
	    @case('2')@include('livewire.general.enrollment.form.enrollment.representant')@break
	    @case('3')@include('livewire.general.enrollment.form.student_records.partials.general')@break
	    @case('4')@include('livewire.general.enrollment.form.student_records.partials.illness')@break
	    @case('5')@include('livewire.general.enrollment.form.student_records.partials.parents')@break
	    @default
	@endswitch

	@include('livewire.general.enrollment.form.button')
