        ...
        <div class="col-8">
            ...
            <div class="p-2 m-2">
                ...
                {{-- <div class="form-group">
                    @php $name = 'pensum_id' ; $model = 'question.'.$name @endphp
                    <label for="{{$model}}" class=" font-weight-bold m-0 small">{{$list_comment[$name] ?? ''}}</label>
                    {!! Form::select($model,$list_pensum,old($model),['wire:model.defer'=>$model,'class' => 'form-control','id'=>$model,'placeholder'  => 'Selecciones']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::select($model, $list_debates, old($model), [
