        ...
        <div class="d-flex flex-wrap">
            @php
                $fields = [
                    ...
                    'category' => ['options' => $list_category, 'placeholder' => 'Category', 'id' => 'category'],
            ...
            <div class="px-2">
                <a id="" class="btn btn-dark w-100 p-2 mt-1" href="{{ route('evaluacions.competitions.index') }}" role="button" title="Refrescar la página">
                    ...
                    <td class="{{ $class['action'] ?? ''}}">
                        <div class="btn-group btn-group-sm" wire:key="{{$key}}-group-btn-{{$item->id}}">
                            <a target="_blank" class="btn btn-dark btn-sm"
                                href="{{ route('evaluacions.competitions.cards.pdf', [
                                    'pensum_id' => $item->id,
                            ...
                            <a target="_blank" class="btn btn-light btn-sm"
                                href="{{ route('evaluacions.competitions.list.pdf', [
                                    'pensum_id' => $item->id,
                                    'category' => $category ?? 'default_value'
                                ]) }}" role="button">
