            ...
            <p class="card-text">
                <ul class="list-group">
                    ...
                    <li class="list-group-item py-0">
                        <div class="d-flex">
                            <div class="p-2 flex-grow-1 font-weight-bold">
                                <span class=" font-weight-bold">Correo Institucional:</span> 
                            </div>
                            <div class="d-flex align-items-center">{{$estudiant->gsemail ?? null}}</div>
                        </div>
                    </li>
                    {{-- <li class="list-group-item py-0">
                        <div class="d-flex">
                ...
                @include("livewire.evaluacion.estudiant.partials.partials.rendimiento")
            </p>
