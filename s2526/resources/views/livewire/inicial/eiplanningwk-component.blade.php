<div>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <div>
                        <h4 class="mb-1 font-weight-bold">Planes Semanales</h4>
                        <p class="text-muted mb-0">Gestión de planificación pedagógica semanal</p>
                    </div>
                </div>
    ...
    <!-- Plans List -->
    @if ($eiplanningwks->count() > 0)
        <div class="row">
            @foreach ($eiplanningwks as $index => $plan)
                    ...
                    <div class="card border-0 shadow-sm h-100 {{ $loop->even ? 'bg-light' : '' }}">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('inicials.eiplanningwks.format.index', $plan->id) }}"
                                            target="_blank">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-muted mb-0">{{ Str::limit($plan->diagnostico, 300) }}</p>
                                @if (strlen($plan->diagnostico) > 300)
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="badge badge-success">
                                            ...
                                            {{ $plan->getOrderedStrategies()->count() }} Estrategias
                                        </span>
                                    </div>
                                </div>
                                @if ($plan->eiprojectk)
    ...
    @else
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center py-5">
                ...
                <h5 class="text-muted mb-3">No hay planes semanales registrados</h5>
                <p class="text-muted mb-4">Comienza creando tu primer plan semanal para organizar las actividades
                    pedagógicas.</p>
                <button type="button" class="btn btn-primary" wire:click="openModal('create')">
    ...
    <!-- Modals -->
    @include('livewire.inicial.modal.eiplanningwk.main-modal')
