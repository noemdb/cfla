<div class="container border-bottom">
    ...
    <div class="row py-1">        
        <div class="col">
            <div class="form-group">
                @php $name = 'observacion' ; $model= 'eiplanningwk.'.$name @endphp
                <label for="{{$model}}" class="font-weight-bold m-0 small">{{$list_comment[$name] ?? ''}}</label>
                {!! Form::textarea($model, old($model), ['wire:model.defer'=>$model,'class' => 'form-control','placeholder'=>$list_comment[$name],'rows'=>"4"]) !!}
