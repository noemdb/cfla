        ...
        <li class="list-group-item">
            <div class=" d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <span class="badge badge-secondary border rounded p-2"><span class="h6">{{$count_answers ?? null}} / <span class=" font-weight-bold"> {{$count_tokens ?? null}} </span></span></span></span>
                </div>
            </div>
