@php ($chart = ['range'=>'Todos','id_chart'=>'inscritoxgenero_id'.Auth::user()->id,'urlapi'=>route('administracion.administrativas.gender.chart'),'tipo'=>'pie','limit'=>6 ])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header', 'Inscripciones Administrativas por Género')
