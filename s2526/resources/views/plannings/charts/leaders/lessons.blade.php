@php ($chart = ['range'=>1,'id_chart'=>'leaders_lessons_id_'.Auth::user()->id,'urlapi'=>route('evaluacions.charts.leaders.lessons'),'tipo'=>'line','limit'=>10,'legend'=>true,'y_axes'=>'Cantidad de Evaluaciones','x_axes'=>'Días'])
@section('scripts')
    @parent
...
@component('administracion.elements.card.panel')
    ...
    @slot('header','Cantidad diaria de lecciones')
