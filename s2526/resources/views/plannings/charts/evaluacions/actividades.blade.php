@php ($chart = ['range'=>1,'id_chart'=>'actividades_id_'.Auth::user()->id,'urlapi'=>route('plannings.charts.evaluacions.actividades'),'tipo'=>'line','limit'=>10,'legend'=>true,'y_axes'=>'Cantidad de Evaluaciones','x_axes'=>'Días'])
@section('scripts')
    @parent
