...
{
    protected $rules = [
        'enrollment.ci_estudiant'=>'required',
        ...
        'enrollment.dir_address'=>'nullable',
        ...
        'enrollment.profession_representant'=>'required',
        ...
        'enrollment.pending_matter' => 'nullable',
        'enrollment.blood_type' => 'required',
        'enrollment.status_brother' => 'required',
        'enrollment.order_born' => 'required',
        'enrollment.weight' => 'required',
        'enrollment.height' => 'required',
        'enrollment.mother_address' => 'nullable',
        'enrollment.father_address' => 'nullable',
        'enrollment.laterality' => 'required',
    ];
    ...
    protected function validationAttributes()
    {
        return [
            ...
            'enrollment.profession_representant' => $this->list_comment['profession_representant'],
            ...
            'enrollment.pending_matter' => $this->list_comment['pending_matter'],
            'enrollment.blood_type' => $this->list_comment['blood_type'],
            'enrollment.status_brother' => $this->list_comment['status_brother'],
            'enrollment.order_born' => $this->list_comment['order_born'],
            'enrollment.weight' => $this->list_comment['weight'],
            'enrollment.height' => $this->list_comment['height'],
            'enrollment.mother_address' => $this->list_comment['mother_address'],
            'enrollment.father_address' => $this->list_comment['father_address'],
        'enrollment.laterality' => $this->list_comment['laterality'],
        ];
    }
}
