...
namespace App\Http\Controllers\Controls\Tab;
...
class ControlController extends Controller
{
    ...
    {
        $this->middleware(['auth','is_controls']);
    }
    public function performance()
    {
        ...
        return view('controls.performances.index',compact('pestudios','grados','area_conocimientos','profesors','list_comment','indicadores'));
    }
}
