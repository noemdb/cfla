...
class Eispecialk extends Model
{
    ...
    public function activities() { return $this->hasMany(Eispecialact::class,'eispecialk_id'); }
    public function eispecialkstrategies() { return $this->hasMany(Eispecialstrategy::class,'eispecialk_id'); }
    ...
    public function getPevaluacions($profesor_id=null,$lapso_id=null) //{$this->asignatura->code} {$grado_code} {$seccion_name} {$lapso_code_sm}
    {
        ...
        $pevaluacions = $pevaluacions->get(); //dd($pevaluacions,$this->seccion_id,$profesor_id,$lapso_id);
    ...
    {
        return $this->eispecialkstrategies()
