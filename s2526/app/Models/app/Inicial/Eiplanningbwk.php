...
class Eiplanningbwk extends Model
{
    ...
    public function eiplanningbwsummaries() { return $this->hasMany(Eiplanningbwsummary::class,'eiplanningbwk_id'); }
    public function eiplanningbwstrategies() { return $this->hasMany(Eiplanningbwstrategy::class, 'eiplanningbwk_id'); }
