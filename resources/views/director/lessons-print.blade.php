...
<body class="lms-print">
    ...
    <script>
        ...
        // data-mermaid-state al terminar, de modo que:
        //   • un diagrama con error no bloquee la espera (antes: 10s siempre);
        //   • un conjunto grande de diagramas no se imprima a medias con SVGs
        //     en blanco (antes: el cap fijo de 10s disparaba el print prematuro).
        // El timeout de seguridad (30s) solo aplica si el chunk de mermaid no
        // llega a cargar (los wrappers quedarían en 'rendering' sin fin).
