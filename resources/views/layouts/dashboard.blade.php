                ...
                <nav class="hidden lg:flex items-center space-x-1 mr-auto">
                    @if(Auth::user()->is_admin || Auth::user()->is_diagnostic)
                        <a href="{{ route('admin.index') }}"
                            class="inline-flex items-center gap-1.5 text-sm font-medium rounded-lg px-3 py-1.5 transition-all duration-200 {{ request()->routeIs('admin.index') ? 'bg-emerald-500/10 text-emerald-400' : 'text-gray-400 hover:text-emerald-300 hover:bg-white/5' }}">
                    ...
                    @if(Auth::user()->is_admin)
                        <a href="{{ route('admin.voting.dashboard') }}"
                            class="inline-flex items-center gap-1.5 text-sm font-medium rounded-lg px-3 py-1.5 transition-all duration-200 text-gray-400 hover:text-emerald-300 hover:bg-white/5">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
