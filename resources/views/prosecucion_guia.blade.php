...
<body class="bg-gradient-to-br from-gray-900 via-green-900 to-slate-900 min-h-screen">
    ...
    <section class="py-16 px-4">
        <div class="container mx-auto max-w-6xl">
            <div class="text-center mb-12">
                <h2 class="text-lg font-bold text-white mb-2">Proceso Paso a Paso</h2>
                ...
                <div class="bg-gray-800 rounded-lg shadow-2xl border border-green-700 overflow-hidden">
                    ...
                    <div class="p-8">
                        <div class="grid md:grid-cols-2 gap-8 items-center">
                            <div>
                                <h4 class="text-lg font-semibold text-white mb-2">¿Qué necesitas hacer?</h4>
                            ...
                            <div class="bg-gray-900 rounded-lg p-6 border border-green-600">
                                <h5 class="text-lg font-semibold text-white mb-2">Ejemplo de entrada:</h5>
                                <div class="space-y-3">
                ...
                <div class="bg-gray-800 rounded-lg shadow-2xl border border-green-700 overflow-hidden">
                    ...
                    <div class="p-8">
                        <div class="grid md:grid-cols-2 gap-8 items-start">
                            <div>
                                <h4 class="text-lg font-semibold text-white mb-2">¿Cómo seleccionar?</h4>
                            ...
                            <div class="bg-gray-900 rounded-lg p-6 border border-blue-600">
                                <h5 class="text-lg font-semibold text-white mb-2">Ejemplo de selección:</h5>
                                <div class="space-y-3">
                                    <!-- Estudiante 1 -->
            ...
            <div class="mb-16">
                <div class="bg-gray-800 rounded-lg shadow-2xl border border-green-700 overflow-hidden">
                    ...
                    <div class="p-8">
                        <div class="grid md:grid-cols-2 gap-8 items-start">
                            <div>
                                <h4 class="text-lg font-semibold text-white mb-2">¿Qué obtienes?</h4>
                                <ul class="space-y-3 text-gray-300 mb-6">
                                    <li class="flex items-start">
                                        <svg class="w-5 h-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="bg-gray-900 rounded-lg p-6 border border-purple-600">
                                <h5 class="text-lg font-semibold text-white mb-2">Pantalla de confirmación:</h5>
                                ...
                                <div class="bg-gray-800 rounded-lg p-4 border border-green-600">
                                    ...
                                    <div class="bg-green-900/20 rounded-lg p-3 mb-2">
    ...
    <section class="py-16 px-4 bg-gray-800/50">
        <div class="container mx-auto max-w-4xl">
            <div class="text-center mb-12">
                <h2 class="text-lg font-bold text-white mb-2">Preguntas Frecuentes</h2>
    ...
    <section class="py-16 px-4">
        <div class="container mx-auto max-w-4xl text-center">
            <div class="bg-gradient-to-r from-green-600 to-green-700 rounded-lg p-8 shadow-2xl">
                <h2 class="text-lg font-bold text-white mb-2">¿Listo para confirmar?</h2>
