                    ...
                    <div class="flex-1 space-y-2">
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full bg-white/5 border border-white/10 text-white rounded-xl pl-10 pr-5 py-4 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none"
                                placeholder="Introduce la opción..."
                                required
                            >
                        </div>
                    </div>
                    <button type="button" onclick="removeOption(this)" class="p-4 text-red-400 hover:text-white bg-red-500/10 hover:bg-red-500 rounded-xl border border-red-500/20 transition-all duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
