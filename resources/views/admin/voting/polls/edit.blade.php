        ...
        <div class="container mx-auto px-4 py-8">
            <div class="max-w-2xl mx-auto">
                ...
                <form action="{{ route('admin.voting.polls.update', $poll) }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-2">Opciones de Votación</h2>
                    ...
                    @if ($poll->votes_count > 0)
                        <div class="bg-white rounded-lg shadow p-6">
                            <h2 class="text-lg font-semibold text-gray-900 mb-2">Estadísticas Actuales</h2>
                    ...
                    <div class="flex-1 space-y-2">
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full bg-white/5 border border-white/10 text-white rounded-lg pl-10 pr-5 py-2 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all outline-none"
                                placeholder="Introduce la opción..."
                                required
                            >
                        </div>
                    </div>
                    <button type="button" onclick="removeOption(this)" class="p-4 text-red-400 hover:text-white bg-red-500/10 hover:bg-red-500 rounded-lg border border-red-500/20 transition-all duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
