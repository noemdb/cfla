    ...
    <div class="w-full max-w-md">
        <div class="diagnostic-card bg-gray-900/40 backdrop-blur-md border border-emerald-500/20 rounded-lg shadow-2xl overflow-hidden p-8 fade-in">
            <div class="mb-8 text-center text-white">
                <div class="inline-flex items-center justify-center w-20 h-20 bg-emerald-500/10 rounded-full mb-2 border border-emerald-500/20">
                ...
                <h2 class="text-lg font-extrabold mb-2">Planificación Docente</h2>
                <h2 class="text-lg font-extrabold mb-2">Acceso al Sistema</h2>
