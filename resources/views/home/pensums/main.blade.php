<div class="space-y-6">
    ...
    <div class="text-center mb-8">
        ...
        <div class="h-1 w-20 bg-emerald-500 mx-auto rounded-full mt-4"></div>
    </div>
    ...
    <div x-data="{ open: false }" class="text-center mt-6">
        <button @click="open = true"
            class="px-6 py-3 bg-emerald-100 hover:bg-emerald-200 text-emerald-900 font-semibold rounded-lg shadow-sm transition-all duration-200 ease-in-out transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-emerald-300">
                ...
                <div x-show="open" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="p-6">
                        ...
                        <div class="relative w-full overflow-hidden rounded border border-gray-200">
                            <iframe src="https://makeform.ai/e/cjO2oCgV" width="100%" height="400"
                                style="border: none; margin: 0; padding: 0;"
                                title="Formulario de inscripción - Danzas Joropo Recio" loading="lazy"></iframe>
                        </div>
