<div class="space-y-6">
    ...
    <div x-data="{ open: false }" class="text-center mt-6">
        <button @click="open = true"
            class="px-6 py-2 bg-emerald-100 hover:bg-emerald-200 text-emerald-900 font-semibold rounded-lg shadow-sm transition-all duration-200 ease-in-out transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-emerald-300">
