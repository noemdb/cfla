<x-card class="h-full">
    ...
    @slot('header')
    <h3 class="text-green-950 bg-warning-100 rounded-t-xl p-2 text-lg md:text-lg font-bold dark:text-neutral-200">
    ...
    <div
        ...
        <div class="relative overflow-hidden bg-cover bg-no-repeat" data-te-ripple-init data-te-ripple-color="light">
            ...
            <div class="text-center  dark:text-neutral-200">
                <div class="text-lg md:text-lg text-gray-900 dark:text-neutral-200">TPV Botón de Pago CFLA</div>
        ...
        <div class="text-xs text-gray-200flex justify-between items-center bg-orange-100 p-4 my-4 rounded-lg origin-bottom">
            <div class="text-sm md:text-md lg:text-lg xl:text-lg">
                <div class="mb-3 text-neutral-600 dark:text-neutral-200">
