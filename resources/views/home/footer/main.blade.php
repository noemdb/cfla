<footer class="bg-gray-900/95 backdrop-blur-sm text-gray-300 border-t border-emerald-500/30">
    <div class="flex items-center justify-center border-b border-emerald-500/30 p-6 lg:justify-between">
        <div class="mr-12 hidden lg:block text-emerald-100 font-semibold">
            <span>Conéctate con nosotros en nuestras redes sociales:</span>
        </div>
        @include('home.footer.icons')
    </div>

    <div class="mx-6 py-10 text-center md:text-left text-xs text-gray-400">
