...
<div class="">
    ...
    <p>
        <ul class="text-xs">
            <li>-. EZEQUIEL JOSÉ SIERRA RODRIGUEZ</li>
            <li>-. ESCARLETH MARGARITA LOPEZ DE ANTOLINI</li>
            <li>-. YANIRA LEDEZMA VALLES</li>
            <li>-. LIDOSKA BEATRIZ VELIZ DUDAMELL</li>
        </ul>
    </p>
</div>
<!-- Products section -->
...
<div class="">
    ...
    <p class="mb-4">
        <a href="#hero" class="text-green-100 dark:text-green-200">Destacados</a>
    </p>
    <p class="mb-4">
        <a href="#gallery" class="text-green-100 dark:text-green-200">Galería</a>
    </p>
    <p class="mb-4">
        <a href="#testimonials" class="text-green-100 dark:text-green-200">Experiencias</a>
    </p>
    <p>
        <a href="#contacs" class="text-green-100 dark:text-green-200">Contacto</a>
    </p>
</div>
<!-- Contact section -->
<div>
    ...
    <p class="flex items-center justify-center mb-4 md:justify-start">
        ...
        colegiofrayluisa@gmail.com || direccionacademica.c.e.cfla@gmail.com || controldeestudios.c.e.cfla@gmail.com
    </p>
    <p class="flex items-center justify-center mb-4 md:justify-start">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-3">
        ...
        Teléfonos: + 58 424-5891682 || + 58 414-5442298 || + 58 424-5027880
    </p>
</div>