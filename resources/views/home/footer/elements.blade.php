<div class="">
    <h6 class="flex items-center justify-center mb-4 font-semibold uppercase md:justify-start text-emerald-100">
...
<!-- Products section -->
<div class="">
    <h6 class="flex justify-center mb-4 font-semibold uppercase md:justify-start text-emerald-100">
        Planes de Formación
    </h6>
    <p class="mb-4">
...
<div class="">
    ...
    <p>
        <a href="#contacts" class="text-gray-400 hover:text-emerald-400 transition-colors">Contacto</a>
    </p>
</div>
<!-- Contact section -->
<div>
    ...
    <p class="flex items-center justify-center mb-4 md:justify-start text-gray-400">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
