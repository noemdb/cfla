<section class="text-neutral-700 dark:text-neutral-300">
    <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
        <h3 class="mb-6 text-3xl font-bold">Plans</h3>
    ...
    <div class="grid gap-6 text-center md:grid-cols-2">
        <div>
            <div class="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
                <div class="h-28 overflow-hidden rounded-t-lg bg-[#004000ae]"></div>
                <div
                    ...
                    <img data-te-lazy-src="https://tecdn.b-cdn.net/img/Photos/Avatars/img%20(1).webp" data-te-lazy-load-init/>
                </div>
                <div class="p-6">
        ...
        <div>
            <div class="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
                ...
                <div
                    class="mx-auto -mt-12 w-24 overflow-hidden rounded-full border-2 border-white bg-white dark:border-neutral-800 dark:bg-neutral-800">
                    <img data-te-lazy-src="https://tecdn.b-cdn.net/img/Photos/Avatars/img%20(2).webp" data-te-lazy-load-init/>
                </div>
                <div class="p-6">
