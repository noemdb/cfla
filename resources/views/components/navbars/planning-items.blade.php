...
@if(Auth::user()->is_admin || Auth::user()->is_diagnostic || Auth::user()->is_planner)
    <div x-data="{ open: false }" class="relative">
        ...
        <div x-show="open" x-cloak
            ...
            <div class="col-span-2 mb-1 pb-2 border-b border-white/5">
            ...
            <div class="col-span-2 mt-2 pt-3 border-t border-white/5 flex items-center gap-3 px-3">
                <a href="{{ route('app.planning.diagnostico.index') }}"
                    class="inline-flex items-center gap-1.5 text-xs font-medium text-gray-400 hover:text-emerald-300 transition-colors {{ request()->routeIs('app.planning.diagnostico.*') && !request()->routeIs('app.planning.diagnostico.referents.*') ? 'text-emerald-400' : '' }}">
                ...
                <a href="{{ route('app.planning.flow.index') }}"
                    class="inline-flex items-center gap-1.5 text-xs font-medium text-gray-400 hover:text-emerald-300 transition-colors {{ request()->routeIs('app.planning.flow.*') || request()->routeIs('app.planning.diagram.*') ? 'text-emerald-400' : '' }}">
