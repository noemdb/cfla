...
@if(Auth::user()->is_admin || Auth::user()->is_diagnostic || Auth::user()->is_planner)
    <div x-data="{ open: false }" class="relative">
        <button @click="open = !open" @click.outside="open = false"
            class="inline-flex items-center gap-1.5 text-sm font-medium rounded-lg px-3 py-1.5 transition-all duration-200 {{ request()->routeIs('app.planning.*') ? 'bg-emerald-500/10 text-emerald-400' : 'text-gray-400 hover:text-emerald-300 hover:bg-white/5' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="open" x-cloak
            ...
            {{-- Dashboard link (full width) --}}
            <div class="mb-3 pb-2 border-b border-white/5">
                <a href="{{ route('app.planning.index') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.index') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {{-- Filas en flex para que cada columna se adapte al contenido --}}
            ...
            <div class="min-w-max space-y-0.5">
                ...
                <a href="{{ route('app.planning.area-conocimientos.index') }}"
                    ...
                    <svg class="w-4 h-4 text-yellow-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
                ...
                <a href="{{ route('app.planning.inscripcions.index') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.inscripcions.*') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
            ...
            {{-- Columna 3: Herramientas Transversales --}}
            <div class="min-w-max space-y-0.5">
                <div class="text-[10px] font-bold uppercase tracking-widest text-emerald-400/60 px-3 py-1.5">Herramientas</div>
                <a href="{{ route('app.planning.diagnostico.index') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.diagnostico.*') && !request()->routeIs('app.planning.diagnostico.referents.*') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                ...
                <a href="{{ route('app.planning.diagnostico.referents.index') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.diagnostico.referents.*') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                    <svg class="w-4 h-4 text-fuchsia-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    Referentes
                </a>
                <a href="{{ route('app.planning.profesors.index') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.profesors.*') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                    <svg class="w-4 h-4 text-emerald-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    Profesores
                </a>
                <a href="{{ route('app.planning.educational.competition.index') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.educational.*') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                ...
                <a href="{{ route('app.planning.flow.index') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.flow.*') || request()->routeIs('app.planning.diagram.*') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                ...
                <a href="{{ route('app.planning.timetable') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.timetable') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                ...
                <a href="{{ route('app.planning.timetable.substitutes') }}"
                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.planning.timetable.substitutes') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                    <svg class="w-4 h-4 text-rose-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7zM9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    Suplencias
                </a>
            </div>
            </div>
