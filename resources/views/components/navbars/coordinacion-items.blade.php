@if(Auth::user()->is_admin || Auth::user()->isCoordinacion())
    <div x-data="{ open: false }" class="relative">
        ...
        <div x-show="open" x-cloak
            ...
            <a href="{{ route('app.coordinacion.timetable') }}"
                class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.coordinacion.timetable') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
            ...
            <a href="{{ route('app.coordinacion.timetable.substitutes') }}"
                class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('app.coordinacion.timetable.substitutes') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
