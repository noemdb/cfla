                ...
                <div class="bg-gray-800/60 backdrop-blur-sm rounded-lg p-6 border border-emerald-500/30">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-lg font-bold text-white">{{ $activePolls }}</p>
                        </div>
                    </div>
                </div>

                <div class="bg-gray-800/60 backdrop-blur-sm rounded-lg p-6 border border-blue-500/30">
                    <div class="flex items-center">
                        <div
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-lg font-bold text-white">{{ number_format($totalVotes) }}</p>
                        </div>
                    </div>
                </div>

                <div class="bg-gray-800/60 backdrop-blur-sm rounded-lg p-6 border border-teal-500/30">
                    <div class="flex items-center">
                        <div
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-lg font-bold text-white">{{ $pollsWithTimeLimit }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid {{ $gridClass }} gap-8">
                @forelse($polls as $poll)
                    <div
                        ...
                        <div
                            class="bg-gradient-to-r from-green-500/30 to-green-600/30 backdrop-blur-sm px-6 py-2 border-b border-green-500/30">
                        ...
                        <div class="p-6">
                            ...
                            <div class="bg-gradient-to-r from-gray-50/5 to-green-50/5 rounded-lg p-4 mb-2">
                                <div class="grid grid-cols-2 gap-3 text-center">
                                    ...
                                    <div>
                                        <p class="text-lg font-bold text-white">{{ $poll->options->count() }}</p>
                            ...
                            <div class="space-y-2">
                                ...
                                @if ($canVote)
                                    <a href="{{ route('poll.voting.show', $poll->access_token) }}"
                                        class="w-full flex items-center justify-center px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-500/50 shadow-lg">
                                ...
                                @else
                                    <button disabled
                                        class="w-full flex items-center justify-center px-4 py-2 bg-gradient-to-r from-gray-600 to-gray-700 text-gray-300 font-medium rounded-lg cursor-not-allowed opacity-50">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                ...
                                <a href="{{ route('poll.voting.result', $poll->access_token) }}"
                                    class="w-full flex items-center justify-center px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-emerald-500/50 shadow-lg">
                ...
                @empty
                    ...
                    <div class="col-span-full">
                        <div class="text-center py-16">
                            <div class="bg-gray-800/60 backdrop-blur-sm rounded-lg p-12 border border-gray-700">
