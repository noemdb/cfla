        ...
        <div class="bg-gradient-to-r from-green-900/80 to-green-800/80 backdrop-blur-sm border-b border-green-700/30">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div class="text-center">
                    <div
                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 rounded-full text-white text-sm font-medium mb-2">
                    ...
                    <h1 class="text-4xl font-bold text-white mb-2">{{ $poll->title }}</h1>
                    @if ($poll->description)
