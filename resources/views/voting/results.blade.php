                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-lg font-bold text-white">{{ $polls->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex flex-col space-y-1 text-emerald-200 text-xs">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="font-mono truncate">{{ substr($poll->access_token, 0, 8) }}...</span>
                                        </div>
                                    </div>
                                </div>
                ...
                @empty
                    ...
                    <div class="text-center py-16">
                        <div class="bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-700 p-12">
                            ...
                            <h3 class="text-lg font-bold text-white mb-4">No hay encuestas activas</h3>
