    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-900 via-green-900 to-gray-900 py-8">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="que-es-asistente"
                ...
                <div class="space-y-6 text-gray-300">
                    <div
                        ...
                        <h3 class="text-lg font-semibold text-white mb-2">🤖 Asistente Inteligente de Votación</h3>
            ...
            <div id="como-acceder"
                ...
                <div class="space-y-6">
                    <div class="bg-gradient-to-r from-blue-700/20 to-blue-800/20 rounded-lg p-6 border border-blue-700/30">
                        ...
                        <div class="bg-gray-900/50 rounded-lg p-4 mb-2">
                    ...
                    <div class="bg-green-700/20 border border-green-700/30 rounded-lg p-6">
                        ...
                        <div class="text-center">
                            <a href="{{ route('voting.asistent') }}"
                                class="inline-flex items-center px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg">
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex items-start space-x-4">
                        <div
                            ...
                            1</div>
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-white mb-2">Inicialización del Sistema</h3>
                    ...
                    <div class="flex items-start space-x-4">
                        <div
                            ...
                            2</div>
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-white mb-2">Navegación por las Encuestas</h3>
                    ...
                    <div class="flex items-start space-x-4">
                        <div
                            ...
                            3</div>
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-white mb-2">Selección y Confirmación de Voto</h3>
                            <div class="bg-gray-700/50 rounded-lg p-4">
                                <div class="space-y-4">
                                    <div>
                    ...
                    <div class="flex items-start space-x-4">
                        <div
                            ...
                            4</div>
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-white mb-2">Navegación entre Encuestas</h3>
                            <div class="bg-gray-700/50 rounded-lg p-4">
                                <p class="text-gray-300 mb-2">
            ...
            <div id="navegacion-asistente"
                ...
                <div class="space-y-6">
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                <h4 class="font-semibold text-white mb-2">📊 Elementos de la Interfaz</h4>
                                <div class="space-y-3">
                            ...
                            <div class="space-y-4">
                                <h4 class="font-semibold text-white mb-2">🎨 Estados Visuales</h4>
                                <div class="space-y-3">
                                    <div class="bg-gray-700/50 rounded-lg p-3">
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
                <a href="{{ route('voting.asistent') }}"
                    class="inline-flex items-center px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                ...
                {{-- <a href="{{ route('voting.index') }}"
                    class="inline-flex items-center px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
