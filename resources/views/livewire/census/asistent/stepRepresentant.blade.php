    ...
    <form method="POST" action="#" class="space-y-2">
        ...
        <div class="grid md:grid-cols-1">
            ...
            <div class="space-y-2 mb-2">
                <x-input wire:model="representant_name" label="Nombre completo" placeholder="Nombre completo"
                    right-icon="user" class="mb-2" />
            </div>

            <div class="space-y-2 mb-2">

                <x-input wire:model="representant_ci" label="Cédula de Identidad" placeholder="Cédula de Identidad"
            ...
            <div class="space-y-2 mb-2">
                ...
                {{-- <x-input wire:model="representant_phone" label="Número de teléfono" placeholder="58 414 145-9834" class="mb-2" suffix="#" /> --}}
                <x-phone id="representant_phone" wire:model="representant_phone" label="Número de teléfono"
                    placeholder="58 414 145-9834" :mask="['+## ## ####-####']" right-icon="phone" />
            ...
            <div class="space-y-2 mb-2">
                <x-button xl wire:click="saveCatchment" positive label="Guarda tus datos"
