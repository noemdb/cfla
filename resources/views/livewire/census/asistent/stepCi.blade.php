<div class="max-w-sm mx-auto">
    <h2 class="mb-2 text-lg font-bold text-white">Consultar</h2>

    <div class="grid md:grid-cols-1">
        @if ($is_regular)
            <div class="p-4 mb-2 text-sm text-red-100 bg-red-900 border border-red-700 rounded-lg shadow-lg animate-pulse"
                role="alert">
        ...
        <p class="mb-2 text-gray-400">Por favor, ingresa tu cédula de identidad para consultar el estatus del censo de
