<div class="max-w-sm mx-auto">
    <h2 class="mb-2 text-lg font-bold text-white">Paso 2</h2>
    ...
    <div class="grid md:grid-cols-1">
        ...
        @if (!$verificationCode)
            ...
            <p class="mb-2 text-gray-400">Ingresa tu dirección de correo electrónico</p>
        ...
        @else
            ...
            <p class="mb-2 text-gray-400">Se ha enviado un código a tu correo electrónico</p>

            <x-card>
                <p class="mb-2 font-extrabold text-gray-400">
