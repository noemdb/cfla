<div class="bg-gray-900 border border-green-800 rounded-lg shadow-2xl p-6">
    @if($step == 1)
        ...
        <div class="text-center">
            <div class="mb-6">
                <div class="w-20 h-20 mx-auto mb-2 bg-gradient-to-br from-green-700 to-green-900 rounded-full flex items-center justify-center shadow-xl border-2 border-green-600">
    ...
    @elseif($step == 3)
        ...
        <div class="text-center">
            <div class="mb-6">
                <div class="w-20 h-20 mx-auto mb-2 bg-gradient-to-br from-green-600 to-green-800 rounded-full flex items-center justify-center shadow-xl animate-pulse border-2 border-green-500">
            ...
            <div class="bg-gradient-to-r from-green-900/40 to-green-800/40 rounded-lg p-6 mb-6 border border-green-700">
                <h3 class="text-lg font-semibold text-white mb-2 flex items-center justify-center">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-300 mb-2 bg-green-900/30 p-3 rounded-lg border border-green-700">
