...
<div x-data="{ show: @entangle('showParticipationModal') }" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div class="inline-block w-full max-w-6xl my-8 overflow-hidden text-left align-middle transition-all transform bg-gray-800 shadow-2xl rounded-lg border border-gray-700"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="bg-gray-700/50 rounded-lg p-4">
                                ...
                                @if ($selectedParticipation->votes->isNotEmpty())
                                    @foreach ($selectedParticipation->votes as $vote)
                                        <div class="bg-green-900/30 border border-green-700 rounded-lg p-4 mb-2">
                                            <div class="flex items-center justify-between">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-700/50 rounded-lg p-4 text-center">
                                <h4 class="text-lg font-semibold text-white mb-2 flex items-center justify-center">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-700/50 rounded-lg p-4">
                                ...
                                <div id="participation-ticket"
                                    ...
                                    <!-- Header del Ticket -->
                                    <div class="text-center border-b-2 border-dashed border-gray-300 pb-4 mb-2">
