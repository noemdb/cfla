<div class="fixed inset-0 z-[9999] overflow-y-auto" wire:key="detail-modal-{{ $detailQuestion->id }}">
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
        <div class="relative w-full max-w-3xl bg-gray-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="px-6 py-5 max-h-[75vh] overflow-y-auto">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="bg-gray-800/40 border border-white/5 rounded-xl p-4">
                    ...
                    @if($detailQuestion->observation)
                        <div>
                            ...
                            <div class="bg-gray-800/40 border border-white/5 rounded-xl p-3">
                    ...
                    <div>
                        ...
                        @if($detailQuestion->options->isEmpty())
                            <div class="text-center py-6 bg-gray-800/20 border border-dashed border-white/5 rounded-xl">
