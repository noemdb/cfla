    ...
    <div class="md:col-span-2 space-y-3">
        ...
        <div>
            ...
            <textarea wire:model="activityForm.teachingStart" rows="2"
                class="w-full bg-gray-800/50 border border-white/10 rounded-xl px-3 py-2 text-xs text-gray-300 focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all duration-200"
        ...
        <div>
            ...
            <textarea wire:model="activityForm.teachingEnd" rows="2"
                class="w-full bg-gray-800/50 border border-white/10 rounded-xl px-3 py-2 text-xs text-gray-300 focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/20 transition-all duration-200"
