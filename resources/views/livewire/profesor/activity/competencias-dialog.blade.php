    ...
    @if($showModal)
        <div class="fixed inset-0 z-[9999] overflow-y-auto" wire:key="competencias-modal">
            ...
            <div class="relative min-h-screen flex items-start justify-center p-4 pt-8 pb-24">
                <div class="relative w-[95vw] max-w-6xl bg-gray-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden"
                    ...
                    <div class="p-8 max-h-[80vh] overflow-y-auto">
                        ...
                        @empty
                            ...
                            <div class="py-16 text-center">
                                <svg class="w-14 h-14 text-gray-700 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {{-- Summary --}}
                        @if($competencias)
                            <div class="mt-4 pt-3 border-t border-white/5 flex items-center gap-4 text-[10px] text-gray-500">
