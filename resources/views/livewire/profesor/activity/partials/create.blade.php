<div class="fixed inset-0 overflow-y-auto z-[60]" wire:key="create-activity-modal">
    ...
    <div class="relative min-h-screen flex items-start justify-center pt-8 pb-12">
        <div class="relative w-[95vw] max-w-[95vw] bg-gray-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden" @click.away="close">
            ...
            <div class="px-6 py-3 border-t border-white/5 bg-gray-800/30 flex items-center justify-between">
                ...
                <button wire:click="save"
                    class="inline-flex items-center gap-2 px-6 py-2 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white border border-emerald-400/20 transition-all duration-200">
