            ...
            <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
                ...
                @if($hasSchedule)
                    <div class="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-amber-500/10 border border-amber-500/20 shadow-lg">
                        ...
                        <span class="text-[10px] font-semibold text-amber-400 whitespace-nowrap">⏰ {{ \Carbon\Carbon::parse($this->publishAt)->format('d/m/Y H:i') }} · Pendiente de aprobación{{ $this->saved ? '' : ' · Sin guardar' }}</span>
                    </div>
                @else
