        ...
        <div class="border-b border-white/5">
            <div class="flex w-full">
                <button wire:click="setActiveTab('dashboard')"
                    class="flex-1 flex items-center justify-center gap-1.5 px-3 py-3 text-xs font-bold uppercase tracking-wider transition-all duration-200 border-b-2 {{ $activeTab === 'dashboard' ? 'text-purple-400 border-purple-500' : 'text-gray-500 border-transparent hover:text-gray-300 hover:border-gray-500' }}">
                ...
                <button wire:click="setActiveTab('questions')"
                    class="flex-1 flex items-center justify-center gap-1.5 px-3 py-3 text-xs font-bold uppercase tracking-wider transition-all duration-200 border-b-2 {{ $activeTab === 'questions' ? 'text-purple-400 border-purple-500' : 'text-gray-500 border-transparent hover:text-gray-300 hover:border-gray-500' }}">
                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button wire:click="setActiveTab('sessions')"
                    class="flex-1 flex items-center justify-center gap-1.5 px-3 py-3 text-xs font-bold uppercase tracking-wider transition-all duration-200 border-b-2 {{ $activeTab === 'sessions' ? 'text-purple-400 border-purple-500' : 'text-gray-500 border-transparent hover:text-gray-300 hover:border-gray-500' }}">
                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button wire:click="setActiveTab('analytics')"
                    class="flex-1 flex items-center justify-center gap-1.5 px-3 py-3 text-xs font-bold uppercase tracking-wider transition-all duration-200 border-b-2 {{ $activeTab === 'analytics' ? 'text-purple-400 border-purple-500' : 'text-gray-500 border-transparent hover:text-gray-300 hover:border-gray-500' }}">
                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                    </svg>
                    Análisis
