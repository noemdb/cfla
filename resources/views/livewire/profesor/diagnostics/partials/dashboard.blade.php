...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-gray-800/30 border border-white/5 rounded-xl p-4">
            ...
            <p class="text-2xl font-bold text-white">{{ number_format($stats['total_questions']) }}</p>
        </div>
        ...
        <div class="bg-gray-800/30 border border-white/5 rounded-xl p-4">
            ...
            <p class="text-2xl font-bold text-white">{{ number_format($stats['completed_sessions']) }}</p>
        ...
        <div class="bg-gray-800/30 border border-white/5 rounded-xl p-4">
            ...
            <p class="text-2xl font-bold text-white">{{ $stats['student_accuracy'] }}%</p>
