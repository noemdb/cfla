            ...
            <div class="p-6" x-data="{ tab: 'published' }">
                ...
                <div class="bg-gray-50 dark:bg-slate-700/20 border border-gray-200 dark:border-slate-600/30 rounded-lg p-4 mb-6">
                    <p class="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
                        ...
                        Como usuario de <strong class="text-gray-900 dark:text-white">planificación, supervisión y seguimiento</strong>, comprender estos estados te permite
                        evaluar el avance docente, identificar oportunidades de mejora y garantizar que el contenido digital
                        esté disponible para los estudiantes cuando lo necesiten.
                    </p>
                </div>
                            ...
                            <div x-show="open" x-transition:enter="transition-all duration-200">
                                <div class="px-4 pb-4">
                                    <div class="bg-white dark:bg-slate-800/50 rounded-lg border border-gray-200 dark:border-slate-700/50 p-3 space-y-1.5">
                                        <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-slate-400"><span class="w-2 h-2 rounded-full bg-emerald-400"></span><span>El profesor de <strong class="text-gray-800 dark:text-slate-200">Matemáticas</strong> completa y publica la lección <strong class="text-gray-800 dark:text-slate-200">«Ecuaciones de primer grado»</strong></span></div>
                ...
                <div x-show="tab === 'scheduled'" x-transition:enter="transition-opacity duration-200">
                    <div class="space-y-3">
                        ...
                        <div class="bg-gray-50 dark:bg-slate-700/20 border border-gray-200 dark:border-slate-600/30 rounded-lg overflow-hidden" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition-all duration-200">
                                <div class="px-4 pb-4 space-y-3">
                                    <p class="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">El estado <strong class="text-gray-900 dark:text-white">Programado</strong> es un excelente indicador de <strong class="text-gray-900 dark:text-white">planificación docente</strong>. Muestra que el profesor no solo creó el contenido sino que también definió cuándo debe estar disponible. Desde la supervisión:</p>
                                    <ul class="space-y-2 text-sm text-gray-700 dark:text-slate-300">
                                        <li class="flex items-start gap-2"><span class="text-amber-600 dark:text-amber-400 mt-0.5">▸</span><span><strong class="text-gray-800 dark:text-slate-200">Aprovecha para auditar</strong> el contenido <strong class="text-gray-800 dark:text-slate-200">antes</strong> de que se publique. Usa la vista previa para verificar que esté completo y correcto.</span></li>
                                        ...
                                        <li class="flex items-start gap-2"><span class="text-amber-600 dark:text-amber-400 mt-0.5">▸</span><span><strong class="text-gray-800 dark:text-slate-200">Identifica docentes</strong> que usan la programación como práctica regular — es señal de buena organización pedagógica.</span></li>
                                        <li class="flex items-start gap-2"><span class="text-amber-600 dark:text-amber-400 mt-0.5">▸</span><span><strong class="text-gray-800 dark:text-slate-200">Monitorea la anticipación</strong>: contenidos programados con poca antelación pueden indicar planificación reactiva en lugar de proactiva.</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="bg-gray-50 dark:bg-slate-700/20 border border-gray-200 dark:border-slate-600/30 rounded-lg overflow-hidden" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition-all duration-200">
                                <div class="px-4 pb-4">
                                    <div class="flex flex-col gap-2">
                                        <div class="flex items-center gap-3 p-2.5 bg-white dark:bg-slate-800/50 rounded-lg border border-gray-200 dark:border-slate-700/50"><span class="text-xs font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-2 py-1 rounded border border-emerald-200 dark:border-emerald-500/20">Publicar (automático)</span><svg class="w-4 h-4 text-gray-500 dark:text-slate-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg><span class="text-xs text-gray-500 dark:text-slate-400">Al llegar la fecha programada, el sistema publica automáticamente sin intervención manual.</span></div>
                            ...
                            <div x-show="open" x-transition:enter="transition-all duration-200">
                                <div class="px-4 pb-4">
                                    <div class="bg-white dark:bg-slate-800/50 rounded-lg border border-gray-200 dark:border-slate-700/50 p-3 space-y-1.5">
                                        ...
                                        <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-slate-400"><span class="w-2 h-2 rounded-full bg-amber-400"></span><span>Establece una despublicación automática para el viernes siguiente (1 semana de visibilidad)</span></div>
                                        <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-slate-400"><span class="w-2 h-2 rounded-full bg-blue-400"></span><span>El supervisor ingresa al monitor el jueves, filtra por "Programado" y usa la <strong class="text-gray-800 dark:text-slate-200">Vista previa</strong> para auditar el contenido <strong class="text-gray-800 dark:text-slate-200">antes</strong> de que se publique</span></div>
                                        <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-slate-400"><span class="w-2 h-2 rounded-full bg-emerald-400"></span><span>Si el contenido está aprobado, no hace nada — el sistema lo publicará automáticamente el viernes a las 8:00 AM</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
