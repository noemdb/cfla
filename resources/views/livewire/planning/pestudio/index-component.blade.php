            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-white/5">
                        ...
                        <th class="text-left px-4 py-2.5 text-[10px] font-bold uppercase tracking-widest text-gray-500 hidden md:table-cell">Programa</th>
                        <th class="text-center px-4 py-2.5 text-[10px] font-bold uppercase tracking-widest text-gray-500 hidden lg:table-cell">Grados</th>
                        <th class="text-center px-4 py-2.5 text-[10px] font-bold uppercase tracking-widest text-gray-500 hidden lg:table-cell">Planning</th>
                ...
                <tbody class="divide-y divide-white/5">
                    @forelse($pestudios as $pestudio)
                        <tr class="hover:bg-white/[0.02] transition-colors group">
                            <td class="px-5 py-2 text-sm text-gray-400 font-mono">{{ $pestudio->id }}</td>
                            <td class="px-4 py-2">
