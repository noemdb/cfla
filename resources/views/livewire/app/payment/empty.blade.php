<x-modal-card title="No se encontró ningún registro" blur wire:model="modalEmpty" max-width="lg" align="center">
    <div class="bg-gray-900/90 text-center p-6 rounded-lg border border-emerald-500/30">
        <div class="mb-2">
            <div
                class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-red-100 text-red-600 dark:bg-red-900/50 dark:text-red-400 mb-2">
        ...
        <div
            class="flex justify-center text-lg font-mono font-bold text-emerald-400 my-6 tracking-wider bg-gray-800 rounded-lg py-2 border border-dashed border-gray-700">
            {{ $ci ?? '---' }}</div>
        <div class="mt-4">
