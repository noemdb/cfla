        ...
        <div class="space-y-6 pt-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-2 items-center">
                <div class="text-center">
                    <div
                        class="inline-flex justify-center items-center p-3 bg-emerald-500/10 rounded-lg border border-emerald-500/20 mb-2 shadow-lg shadow-emerald-500/5">
            ...
            <div class="">
                <x-input label="Cédula del Representante" placeholder="Ej: 12345678" wire:model="ci"
                    icon="identification" hint="Sin puntos ni guiones" class="mb-2" />

                <x-button emerald full label="Continuar" icon="check" wire:click="search" class="" />
            </div>

            <!-- Helpful Note -->
            <div class="flex items-start gap-3 p-4 bg-emerald-950 rounded-lg border border-emerald-500/10">
