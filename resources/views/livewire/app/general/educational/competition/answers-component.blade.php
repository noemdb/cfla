<div class="space-y-6 fade-in">
    <!-- Filters Bar -->
    <div class="bg-gray-900 p-6 rounded-2xl border border-white/10 shadow-2xl mb-8">
    ...
    @if ($questions->isEmpty())
        <div class="py-20 bg-gray-900/20 border border-white/5 rounded-2xl text-center">
