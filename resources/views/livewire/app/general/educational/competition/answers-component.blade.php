<div class="space-y-6 fade-in">
    <!-- Filters Bar -->
    <div class="bg-gray-900 p-6 rounded-3xl border border-white/10 shadow-2xl mb-8">
    ...
    @if ($questions->isEmpty())
        <div class="py-20 bg-gray-900/20 border border-white/5 rounded-3xl text-center">
    ...
    @else
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach ($questions as $question)
                ...
                @endphp
                <div
                    class="bg-gray-900/40 backdrop-blur-md rounded-2xl p-6 border transition-all duration-300 relative {{ $isVoided ? 'border-red-500/30 shadow-lg shadow-red-500/5' : ($hasAnswer ? 'border-emerald-500/10 hover:border-emerald-500/30' : 'border-white/5 opacity-70') }}">
