            ...
            <div class="grid grid-cols-1 sm:grid-cols-12 gap-2"> 
                ...
                <div class="col-span-8"> 
                    ...
                    @endif                    
                        ...
                        <div class="grid border border-gray-200 rounded-lg shadow-sm p-2 dark:border-gray-700 md:grid-cols-2 bg-white dark:bg-gray-800 h-full">
                            @forelse ($options as $item)
                                ...
                                <figure style="{{ ($status_answer) ? "background-color:#3cb992;" : null}} {{$wrong ?? null}}"  class="text-gray-500 h-full flex flex-col  items-center justify-start py-2 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:bg-gray-800 dark:border-gray-700">                    
                                    <blockquote class="max-w-2xl mx-auto mb-2 lg:mb-2 dark:text-gray-400 h-full" >
                                    ...
                                    <figcaption class="flex items-center justify-center h-full">
