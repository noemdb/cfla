<div class="text-sm font-medium">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        <div class="col-span-12 lg:col-span-5 text-start">
            <div class="flex items-center justify-between mb-2 border-b border-emerald-500/10 pb-2">
            ...
            <ul class="space-y-3 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                @forelse ($questions as $item)
                    ...
                    <li class="group">
                        <button wire:click="active({{ $item->id }})"
                            class="w-full text-start p-4 rounded-lg border transition-all duration-300 relative overflow-hidden
                            {{ $active
                ...
                @empty
                    <li
                        class="py-8 text-center text-gray-600 italic border border-dashed border-emerald-500/10 rounded-lg">
        ...
        <div class="col-span-12 lg:col-span-7">
            @if ($active_id)
                ...
                <div class="bg-gray-900/20 rounded-lg p-6 border border-emerald-500/10">
            ...
            @else
                <div
                    ...
                    <svg class="w-16 h-16 text-emerald-500/20 mb-2" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
