                ...
                <div class="flex flex-wrap justify-center md:justify-end gap-2">
                    @forelse ($seccions as $item)
                        <button wire:click="saveAnswerSeccion({{ $item->id }}, true)"
                            class="px-6 py-3 bg-emerald-600 text-white rounded-xl font-bold text-sm uppercase tracking-widest hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-600/20 border border-emerald-400/30">
                            {{ $item->name }}
                        </button>
                    @empty
                        <div class="px-4 py-2 bg-red-950/40 border border-red-500/30 text-red-500 rounded-xl text-xs font-black uppercase tracking-widest">
