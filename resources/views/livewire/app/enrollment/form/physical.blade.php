...
<div class="pb-2">
    ...
    <x-inputs.maskable mask="##" label="{{$label}}" placeholder="{{$label}}" wire:model.defer="{{$model}}" right-icon="table" />
...
<div class="pb-2">
    ...
    <x-inputs.maskable mask="##" right-icon="table" label="{{$label}}" wire:modeL="{{$model}}"/>
    @error($model)<span class="text-red-600 small mb-2">{{ $message }}</span> @enderror
</div>
