<div class="space-y-6 text-white text-center">
    ...
    <div class="bg-white/5 border border-white/10 p-6 rounded-lg backdrop-blur-md text-left">
    ...
    <div class="pt-4">
        <x-button label="Comenzar Proceso" wire:click="setStart"
            class="w-full py-4 rounded-lg font-bold uppercase tracking-wider bg-emerald-600 hover:bg-emerald-500 text-white border-none shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all duration-300" />
    </div>
</div>
