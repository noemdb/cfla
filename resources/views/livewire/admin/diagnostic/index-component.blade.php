        ...
        <div class="mb-12 bg-gray-900/20 backdrop-blur-sm border border-white/5 rounded-lg overflow-hidden transition-all duration-300 hover:border-emerald-500/10"
            ...
            <div @click="open = !open"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-white group-hover:text-emerald-50 transition-colors">
                            {{ $pestudio->name }}</h2>
            ...
            <div x-show="open" x-collapse x-cloak>
                <div class="p-6 pt-0 border-t border-white/5">
                    <div
                        class="text-[10px] text-gray-500 py-2 font-bold uppercase tracking-widest flex items-center gap-2">
