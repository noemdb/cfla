            ...
            <div
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="{{ route('general.educational.competition.moderator', $competition->token) }}"
                        ...
                        <span class="text-[9px] font-bold uppercase tracking-wider text-gray-400">Moderador</span>
                    </a>
                    ...
                    <a href="{{ route('general.educational.competition.scoreboard', $competition->token) }}"
                        ...
                        <span class="text-[9px] font-bold uppercase tracking-wider text-gray-400">Puntaje</span>
                    </a>
                </div>
            </div>
        @empty
