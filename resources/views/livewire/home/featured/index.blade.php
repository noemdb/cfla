<h5
    class="text-lg md:text-lg lg:text-lg flex items-center text-emerald-800 dark:text-emerald-100 font-bold mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-300 transition-colors duration-300">
