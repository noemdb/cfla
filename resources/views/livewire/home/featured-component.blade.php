<div id="feature-category" class="space-y-8">
    ...
    @foreach ($posts as $item)
        ...
        <div
            class="group diagnostic-card relative bg-gray-900/40 backdrop-blur-sm border border-emerald-500/30 rounded-xl overflow-hidden hover:border-emerald-500/60 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/10 hover:-translate-y-1">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="p-6 flex-1 relative z-10">
                    <div class="flex items-center mb-4">
                        <div
                            class="flex-shrink-0 p-3 bg-emerald-900/30 rounded-lg border border-emerald-500/20 group-hover:bg-emerald-500/20 transition-colors duration-300">
                        ...
                        <h3
                            class="ml-4 text-xl font-bold text-emerald-100 group-hover:text-emerald-400 transition-colors duration-300">
                            {{ $category->name }}</h3>
                    </div>
                ...
                @if ($item->file_exist)
                    <div class="md:w-1/3 lg:w-1/4 relative min-h-[250px] md:min-h-0 overflow-hidden">
                        <img src="{{ asset($item->saefl_image_url) }}"
                            ...
                            alt="{{ $item->title }}" />
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40 to-transparent md:bg-gradient-to-l md:via-gray-900/20">
                        </div>
