<ul class="mr-auto flex flex-col md:flex-row text-green-200" data-te-navbar-nav-ref>
    ...
    {{-- <li class="mb-4 md:mb-0 md:pr-2" data-te-nav-item-ref>
        <a class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-green-200 disabled:text-black/30 dark:hover:text-white dark:focus:text-white md:p-2 [&.active]:text-black/90"
