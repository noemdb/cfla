<div class="flex flex-col md:flex-row items-center justify-between gap-2 sm:gap-4 mt-0 sm:mt-4">
    ...
    <div class="flex justify-start">
        <button wire:click="showItem({{ $item->id }})"
            class="px-4 py-1.5 sm:px-6 sm:py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-sm sm:text-base font-bold rounded-full shadow-lg shadow-emerald-500/30 transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
            <span>Leer Más</span>
