    ...
    <div class="grid gap-6 md:grid-cols-3">
        ...
        <div class="h-full">
            <div
                ...
                <div class="p-6 flex-1 flex flex-col">
                    <h4 class="mb-2 text-lg font-bold text-emerald-800 dark:text-emerald-100 text-center">Educación
                        Inicial</h4>
                    ...
                    <ul class="w-full text-center text-gray-600 dark:text-gray-400 text-sm space-y-2 mt-auto">
                        ...
                        <li class="w-full border-b border-emerald-500/10 py-1">Certificado de Promoción</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="h-full">
            <div
                ...
                <div class="p-6 flex-1 flex flex-col">
                    <h4 class="mb-2 text-lg font-bold text-emerald-800 dark:text-emerald-100 text-center">Media General
                    </h4>
                    <hr class="border-emerald-500/30" />
                    <p class="mt-4 flex-1 text-sm text-gray-600 dark:text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        ...
                        Ofrece una formación científica y tecnológica sólida, que prepara a los estudiantes para
                    ...
                    <ul class="w-full text-center text-gray-600 dark:text-gray-400 text-sm space-y-2 mt-auto">
                        ...
                        <li class="w-full border-b border-emerald-500/10 py-1">Bajo la normativa vigente</li>
                        <li class="w-full border-b border-emerald-500/10 py-1">Inscritos en el M.P.P.E</li>
                        <li class="w-full border-b border-emerald-500/10 py-1">Título de Bachiller</li>
                    </ul>
                </div>
            </div>
        </div>
