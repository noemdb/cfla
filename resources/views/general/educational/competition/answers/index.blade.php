...
@section('content')
    ...
    <div class="px-4 py-8 mx-auto w-full sm:px-6 lg:px-8 fade-in">
        <div
            class="mb-8 flex flex-col md:flex-row md:items-center justify-between bg-gray-900/40 backdrop-blur-md p-6 rounded-2xl border border-white/5 shadow-xl shadow-blue-500/5">
