...
@section('content')
    ...
    <div class="px-4 py-8 mx-auto w-full sm:px-6 lg:px-8 fade-in">
        <div
            class="mb-8 flex flex-col md:flex-row md:items-center justify-between bg-gray-900/40 backdrop-blur-md p-6 rounded-lg border border-white/5 shadow-xl shadow-blue-500/5">
            <div class="mb-3 md:mb-0">
                <h1 class="text-lg font-extrabold text-white mb-2 tracking-tight">Auditoría de Respuestas</h1>
            ...
            <a href="{{ route('admin.educational.competition.index') }}"
                class="flex items-center justify-center gap-2 px-5 py-2.5 bg-white/5 hover:bg-white/10 text-gray-300 rounded-lg border border-white/5 transition-all text-sm font-bold">
