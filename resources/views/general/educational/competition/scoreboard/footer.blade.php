<footer class="mt-auto bg-green-800 text-white rounded-lg shadow dark:bg-gray-800">
    <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-200 sm:text-center dark:text-gray-400">
            © 2024 <a href="https://uefrayluisamigosf.com/saefl" class="hover:underline font-extrabold">SAEFL</a>. Todos los derechos reservados.
        </span>
