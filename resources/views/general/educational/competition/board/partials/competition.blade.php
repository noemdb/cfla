<div
    class="m-3 diagnostic-card rounded-xl p-8 border border-emerald-500/20 shadow-2xl max-w-2xl mx-auto backdrop-blur-xl">
    <div class="flex flex-col items-center">
        <div class="p-3 bg-emerald-500/20 rounded-xl mb-4">
        ...
        <h5 class="mb-4 text-lg font-black text-white tracking-tight uppercase">
            {{ $competition->name }}
        </h5>
