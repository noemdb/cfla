    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <div class="flex items-center gap-2">
                <div class="font-bold border rounded p-2 dark:bg-gray-800">Pizarra de Resultados {{ $token }}
                </div>
                <a href="{{ url('/') }}" target="_blank"
                    class="font-bold border rounded p-2 text-white bg-emerald-600 hover:bg-emerald-700 transition-colors">Dashboard</a>
            </div>
        </div>
