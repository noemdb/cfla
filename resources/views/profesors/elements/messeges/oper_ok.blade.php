@if(session('success'))
    <div class="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 fade-in" role="alert">
...
@if(session('error'))
    <div class="bg-red-500/10 border border-red-500/20 rounded-xl p-4 fade-in" role="alert">
        <div class="flex items-center space-x-3">
