                ...
                <div class="break-inside-avoid h-full flex flex-col bg-gray-800/30 border border-white/5 rounded-lg hover:border-emerald-500/30 hover:bg-gray-800/50 transition-all duration-200 group">
                    ...
                    <div class="flex items-center justify-between px-3 py-2 gap-2">
                        <div class="flex items-center gap-2.5">
                            ...
                            {{-- Lesson count (lecciones asociadas) --}}
                            <div class="flex items-center gap-1" title="Lecciones asociadas">
                                <span class="inline-flex items-center justify-center w-5 h-5 rounded text-[9px] font-bold {{ $pevaluacion->activities_lessons_count > 0 ? 'bg-violet-500/10 text-violet-400' : 'bg-gray-500/10 text-gray-500' }}">
