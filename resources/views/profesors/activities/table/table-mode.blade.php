    ...
    <table class="w-full text-[11px]">
        ...
        <thead>
            <tr class="border-b border-white/5">
                ...
                {{-- Lecciones --}}
                <th class="px-2 py-2.5 text-center text-[10px] font-bold text-gray-500 uppercase tracking-wider w-20">Lecciones</th>
        ...
        <tbody>
            @forelse($pevaluacions as $index => $pevaluacion)
                ...
                <tr class="border-b border-white/5 hover:bg-gray-700/20 transition-colors group">
                    ...
                    {{-- Lecciones --}}
                    <td class="px-2 py-2.5 text-center">
                        <span class="inline-flex items-center justify-center min-w-[28px] px-1.5 py-0.5 rounded text-[10px] font-bold {{ $pevaluacion->activities_lessons_count > 0 ? 'bg-violet-500/10 text-violet-400' : 'bg-gray-500/10 text-gray-500' }}"
                              title="{{ $pevaluacion->activities_lessons_count }} lecciones asociadas">
                            {{ $pevaluacion->activities_lessons_count }}
                        </span>
                    </td>
