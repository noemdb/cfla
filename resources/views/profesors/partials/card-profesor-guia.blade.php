                                    ...
                                    <td class="px-4 py-2 text-right">
                                        @if($reportesCount > 0)
                                            <div class="flex items-center justify-end gap-1.5 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity">
                                                <a href="#"
                                                    class="min-w-[44px] min-h-[44px] flex items-center justify-center p-2 bg-white/5 hover:bg-cyan-500/10 rounded-lg border border-white/5 hover:border-cyan-500/20 text-gray-400 hover:text-cyan-400 transition-all duration-200">
