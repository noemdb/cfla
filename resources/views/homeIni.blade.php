...
<body>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="md:flex">
                ...
                <div class="flex-1 mb-8 text-center md:text-left">
                    <h3 class="text-xl font-semibold mb-2">5+</h3>
    ...
    <section id="programs" class="py-12 bg-white">
        <div class="container mx-auto px-4">
            ...
            <h2 class="text-xl font-semibold text-center mb-8">Nuestros Programas</h2>
    ...
    <section id="contact" class="bg-gray-100 py-12">
        <div class="container mx-auto px-4">
            ...
            <h2 class="text-xl font-semibold text-center mb-8">Contacto</h2>
