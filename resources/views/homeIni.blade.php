...
<body>
    ...
    <section id="about" class="bg-gray-100 py-12">
        <div class="container mx-auto px-4">
            ...
            <h2 class="text-lg font-semibold mb-4">Acerca de Nosotros</h2>
    ...
    <section id="programs" class="py-12 bg-white">
        <div class="container mx-auto px-4">
            ...
            <h2 class="text-lg font-semibold text-center mb-8">Nuestros Programas</h2>
