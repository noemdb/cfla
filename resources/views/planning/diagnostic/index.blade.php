...
<div class="fade-in">
    {{-- Header --}}
    <div class="mb-8">
        <h1 class="text-2xl font-extrabold text-white mb-2">Administración de Diagnóstico</h1>
        <p class="text-emerald-400 font-medium">Gestión y activación de áreas de formación para la aplicación del diagnóstico académico.</p>
    </div>

    {{-- Módulo de Diagnóstico (Livewire) --}}
    <div class="mb-8">
