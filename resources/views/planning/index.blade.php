    ...
    <div class="fade-in">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col h-full pointer-events-none">
                    <div
                        class="w-12 h-12 bg-orange-500/20 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col h-full pointer-events-none">
                    <div
                        class="w-12 h-12 bg-pink-500/20 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col h-full pointer-events-none">
                    <div
                        class="w-12 h-12 bg-lime-500/20 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col h-full pointer-events-none">
                    <div
                        class="w-12 h-12 bg-indigo-500/20 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col h-full pointer-events-none">
                    <div
                        class="w-12 h-12 bg-rose-500/20 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col h-full pointer-events-none">
                    <div
                        class="w-12 h-12 bg-teal-500/20 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col h-full pointer-events-none">
                    <div
                        class="w-12 h-12 bg-violet-500/20 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
