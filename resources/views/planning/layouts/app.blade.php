            ...
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden lg:flex items-center space-x-1 mr-auto mx-2">
                    ...
                    <a href="{{ route('planning.index') }}"
                        class="inline-flex items-center gap-1.5 text-sm font-medium rounded-lg px-3 py-1.5 transition-all duration-200 {{ request()->routeIs('planning.index') ? 'bg-emerald-500/10 text-emerald-400' : 'text-gray-400 hover:text-emerald-300 hover:bg-white/5' }}">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" @click.outside="open = false"
                            class="inline-flex items-center gap-1.5 text-sm font-medium rounded-lg px-3 py-1.5 transition-all duration-200 {{ !request()->routeIs('planning.index') && request()->routeIs('planning.*') ? 'bg-emerald-500/10 text-emerald-400' : 'text-gray-400 hover:text-emerald-300 hover:bg-white/5' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-show="open" x-cloak
                            ...
                            <div class="space-y-0.5">
                                ...
                                <a href="{{ route('planning.area-conocimientos.index') }}"
                                    class="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-300 hover:text-emerald-300 hover:bg-white/5 rounded-lg transition-colors {{ request()->routeIs('planning.area-conocimientos.*') ? 'text-emerald-400 bg-emerald-500/5' : '' }}">
                            ...
                            <div class="col-span-2 mt-2 pt-3 border-t border-white/5 flex items-center gap-4 px-3">
                                <a href="{{ route('planning.diagnostico.index') }}"
                                    class="inline-flex items-center gap-1.5 text-xs font-medium text-gray-400 hover:text-emerald-300 transition-colors {{ request()->routeIs('planning.diagnostico.*') ? 'text-emerald-400' : '' }}">
