...
class ActivityController extends Controller
{
    ...
    public function create($pevaluacion_id)
    {
        ...
        $this->assertOwnsPevaluacion($pevaluacion);
    ...
    /**
     * Guarda de autorización: la pevaluacion debe pertenecer al profesor
     * autenticado. Antes esto era un IDOR: abriendo la URL con un id ajeno,
     * un profesor podía descargar el PDF o abrir el editor de actividades de
     * cualquier otro profesor (formato/resumen/create).
     */
    private function assertOwnsPevaluacion(Pevaluacion $pevaluacion): void
    {
        if (! $this->profesor || $pevaluacion->profesor_id !== $this->profesor->id) {
            abort(403, 'No tienes permiso para operar sobre actividades de otro profesor.');
        }
    }
}
