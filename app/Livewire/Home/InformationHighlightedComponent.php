...
class InformationHighlightedComponent extends Component
{
    public $images = [];
    public $imagePost;
    ...
    public function mount()
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error("InformationHighlightedComponent: Error scanning directory: " . $e->getMessage());
        }
    ...
    {
        return view('livewire.home.information-highlighted-component');
    }
}
