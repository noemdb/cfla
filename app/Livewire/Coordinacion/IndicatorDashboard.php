...
class IndicatorDashboard extends Component
{
     ...
     */
    public function updatedChartActivitiesRange() { $this->loadChartActivitiesByDay(); }

    public function updatedChartLessonsRange() { $this->loadChartLessonsByDay(); }

    public function updatedChartScheduledRange() { $this->loadChartScheduledByDay(); }
