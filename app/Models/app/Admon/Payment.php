...
class Payment extends Model
{
     ...
     * El modelo vive en la conexión s2526; la tabla binnacle_entries en la
     * conexión default. Cédulas, teléfonos y números de referencia se enmascaran.
     */
    public function auditableAttributes(): array
    {
        return [
            'id',
            'ci_representant', 'name_representant', 'phone',
            'type_pay', 'comment', 'payment_id',
            'ci_estudiant_1', 'ci_estudiant_2', 'ci_estudiant_3', 'ci_estudiant_4',
            'name_estudiant_1', 'name_estudiant_2', 'name_estudiant_3', 'name_estudiant_4',
            'grado_estudiant_1', 'grado_estudiant_2', 'grado_estudiant_3', 'grado_estudiant_4',
            'ammount_1', 'ammount_2', 'ammount_3', 'ammount_4',
            'number_i_pay_1', 'number_i_pay_2', 'number_i_pay_3', 'number_i_pay_4',
        ];
    }
    ...
    {
        $banco_1 = Banco::find($this->banco_id_1);
        $banco_name_1 = ($banco_1) ? $banco_1->name : null;
        $banco_2 = Banco::find($this->banco_id_2);
        $banco_name_2 = ($banco_2) ? $banco_2->name : null;
        $banco_3 = Banco::find($this->banco_id_3);
        $banco_name_3 = ($banco_3) ? $banco_3->name : null;
        $banco_4 = Banco::find($this->banco_id_4);
        $banco_name_4 = ($banco_4) ? $banco_4->name : null;
        $bancos = (object) [
    ...
    {
        $method_1 = MetodoPago::find($this->method_pay_id_1);
        $method_name_1 = ($method_1) ? $method_1->name : null;
        $method_2 = MetodoPago::find($this->method_pay_id_2);
        $method_name_2 = ($method_2) ? $method_2->name : null;
        $method_3 = MetodoPago::find($this->method_pay_id_3);
        $method_name_3 = ($method_3) ? $method_3->name : null;
        $method_4 = MetodoPago::find($this->method_pay_id_4);
        $method_name_4 = ($method_4) ? $method_4->name : null;
        $bancos = (object) [
