...
class Post extends Model implements \App\Contracts\Auditable
{
    use HasFactory;

    /**
     * Allowlist para la bitácora (Spec BINNACLE-001, ADR-005).
     * body (HTML) excluido por volumen; solo metadatos y estado editorial.
     */
    public function auditableAttributes(): array
    {
        return [
            'id', 'user_id', 'category_id', 'title', 'description', 'file_url',
            'order', 'status_priority', 'status_feature', 'status_coverPage',
