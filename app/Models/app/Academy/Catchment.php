...
class Catchment extends Model
{
    ...
    /**
     * Jornadas del Censo: convocatorias en las que el censo debe estar aperturado.
     * Cada jornada es un array con:
     *   'label' => Texto descriptivo para mostrar al usuario
     *   'start' => Fecha de inicio (Y-m-d)
    ...
    const JORNADAS = [
        ...
        [
            'label' => 'Tercera convocatoria: del 26 al 28 de mayo',
            'start' => '2026-05-26',
            'end'   => '2026-05-28',
        ],
        ...
        // --- Agosto ---
        [
            'label' => 'Duodécima convocatoria: del 03 al 07 de agosto',
            'start' => '2026-08-03',
            'end'   => '2026-08-07',
        ],
        [
            'label' => 'Decimotercera convocatoria: del 10 al 14 de agosto',
            'start' => '2026-08-10',
            'end'   => '2026-08-14',
        ],
        [
            'label' => 'Decimocuarta convocatoria: del 17 al 21 de agosto',
            'start' => '2026-08-17',
            'end'   => '2026-08-21',
        ],
        [
            'label' => 'Decimoquinta convocatoria: del 24 al 28 de agosto',
            'start' => '2026-08-24',
            'end'   => '2026-08-28',
        ],
        [
            'label' => 'Decimosexta convocatoria: lunes 31 de agosto',
            'start' => '2026-08-31',
            'end'   => '2026-08-31',
        ],
    ];
    ...
    /**
     * Retorna la jornada más próxima a llegar (primera cuyo 'end' >= hoy).
     * Si todas ya pasaron, retorna la última jornada como fallback.
     */
    public static function getJornadaProxima(): array
    {
        return collect(self::JORNADAS)
            ->first(fn($j) => now()->toDateString() <= $j['end'])
            ?? collect(self::JORNADAS)->last();
    }
    ...
    public function catchment_group()
    {return $this->belongsTo(CatchmentGroup::class, 'group_id');}
    public function grado()
    {return $this->belongsTo(Grado::class, 'grade');}
    public function catchmentInterviews()
    {return $this->hasMany(CatchmentInterview::class, 'catchment_id');}
